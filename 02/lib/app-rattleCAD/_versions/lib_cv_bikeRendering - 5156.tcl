    ...
    proc createDecoration {cv_Name BB_Position type {updateCommand {}}} {
            ...
            switch $type {
                    ...
                    FrontWheel {    # --- create FrontWheel ----------------
                            ...
                            if {$updateCommand != {}}   { $cv_Name bind    $my_Rim    <Double-ButtonPress-1> \
                                                                    [list rattleCAD::view::createEdit  %x %y  $cv_Name                                                                   {     Component(Wheel/Front/RimHeight)                                                                         }     {FrontWheel Parameter} \
                                                                    ]
                                                          rattleCAD::view::gui::object_CursorBinding     $cv_Name    $my_Rim
                                    }
                            }
    ...
    proc createFork {cv_Name BB_Position {updateCommand {}} } {
        ...
        switch -exact $updateCommand {
                      ...
                      switch -glob $Rendering(Fork) {
                          SteelLugged {
                                    $cv_Name bind $ForkBlade(object)  <Double-ButtonPress-1> \
                                                    [list rattleCAD::view::createEdit  %x %y  $cv_Name                                                   {   list://Rendering(ForkBlade@SELECT_ForkBladeType)                                                      Component(Fork/Blade/Width)                                                                 Component(Fork/Blade/DiameterDO)                                                         Component(Fork/Blade/TaperLength)                                                         Component(Fork/Blade/BendRadius)                                                         Component(Fork/Blade/EndLength)                                                     }  {ForkBlade Parameter} \
                                                    ]
            ...
            selectable {            $cv_Name bind $ForkBlade(object)  <Double-ButtonPress-1> \
                                                    [list rattleCAD::view::createEdit  %x %y  $cv_Name                                                   {   list://Rendering(Fork@SELECT_ForkType)                                                  }  {ForkType Select} \
                                                    ]
                                      rattleCAD::view::gui::object_CursorBinding     $cv_Name    $ForkBlade(object)
                }            default {}
        }                                                   
                       ...
                       switch $Rendering(Fork) {
                            SteelLugged {            
                                    $cv_Name bind $ForkCrown(object)  <Double-ButtonPress-1> \
                                                    [list rattleCAD::view::createEdit  %x %y  $cv_Name                                                   {   list://Rendering(Fork@SELECT_ForkType)                                                      file://Component(Fork/Crown/File)                                                         Component(Fork/Crown/Brake/Angle)                                                          Component(Fork/Crown/Brake/Offset)                                                          Component(Fork/Crown/Blade/Offset)                                                          Component(Fork/Crown/Blade/OffsetPerp)                                                  }  {ForkCrown Parameter} \
                                                    ]
                                  }
                            default {            
                                    $cv_Name bind $ForkCrown(object)  <Double-ButtonPress-1> \
                                                    [list rattleCAD::view::createEdit  %x %y  $cv_Name                                                   {   list://Rendering(Fork@SELECT_ForkType)                                                  }  {ForkCrown Parameter} \
                                                    ]
                                  }
                        }
        ...
        switch -exact $updateCommand {
            editable { if {$Rendering(Fork) == {SteelLugged}} {           
                                      $cv_Name bind $ForkDropout(object)  <Double-ButtonPress-1> \
                                                    [list rattleCAD::view::createEdit  %x %y  $cv_Name  {   file://Component(Fork/DropOut/File)                                                         list://Rendering(ForkDropOut@SELECT_DropOutPosition)
                                                                        Component(Fork/DropOut/Offset)                                                          Component(Fork/DropOut/OffsetPerp)                                                  }  {ForkDropout Parameter}                                  ]
