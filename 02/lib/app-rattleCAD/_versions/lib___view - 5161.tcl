...
namespace eval rattleCAD::view {
    ...
    proc rattleCAD::view::create_ValueEdit {cv cv_Name cvEdit cvContentFrame index labelText key} {
    ...
    proc rattleCAD::view::create_TextEdit {cv cv_Name cvEdit cvContentFrame index labelText key} {
    ...
    proc rattleCAD::view::create_ListEdit {type cv cv_Name cvEdit cvContentFrame index labelText key} {
