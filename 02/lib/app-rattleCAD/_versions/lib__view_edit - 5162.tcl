 ...
 namespace eval rattleCAD::view::edit {
   ...
   proc rattleCAD::view::edit::group_RearWheelParameter {x y cv_Name} {
    ...
    proc rattleCAD::view::edit::single_RearBrake_LeverLength {x y cv_Name} {
        ...
        #
        # -- Component Front- & RearWheel -----------------
        #
    proc rattleCAD::view::edit::single_FrontWheelRimHeight {x y cv_Name} {
                # {FrontWheel Parameter}
            rattleCAD::view::createEdit $x $y $cv_Name Component(Wheel/Front/RimHeight)   
    }
    proc rattleCAD::view::edit::single_RearWheelRimHeight {x y cv_Name} {
                # {RearWheel Parameter}
            rattleCAD::view::createEdit $x $y $cv_Name Component(Wheel/Rear/RimHeight)   
    }
