    ...
    proc rattleCAD::cv_custom::createDimension_FrameDrafting_BG     {cv_Name BB_Position type} {
           ...
           set _dim_HeadTube_Angle      [ $cv_Name dimension  angle            [ appUtil::flatten_nestedList [list $pt_01 $Steerer(Stem) $pt_02] ] \
            ...
            if {$Rendering(BottleCage_ST) != {off}} {
                            ...
                            set pt_01                   [ rattleCAD::model::get_Position    SeatTube_BottleCage_Offset  $BB_Position]
                            set pt_02                   [ rattleCAD::model::get_Position    SeatTube_BottleCage_Base    $BB_Position]
            ...
            if {$Rendering(BottleCage_DT_L) != {off}} {
                            set dt_direction            [ rattleCAD::model::get_Direction   DownTube ]
                            set pt_01                   [ rattleCAD::model::get_Position    DownTube_Lower_BottleCage_Offset    $BB_Position ]
                            set pt_02                   [ rattleCAD::model::get_Position    DownTube_Lower_BottleCage_Base      $BB_Position ]
