 ...
 # 
    ...
    proc rattleCAD::cv_custom::createRearMockup {cv_Name} {
            ...
            switch [rattleCAD::model::get_Option ChainStay] {
                   ...
                   {bent}     { set ChainStay(start)           [rattleCAD::model::get_Position ChainStayRearMockup]
                                ...
                                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $tube_CS_CLine      optionChainStay
                                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $tube_CS_left       optionChainStay
                                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $tube_CS_right      optionChainStay
                                    #
    ...
    proc rattleCAD::cv_custom::create_tubeProfile_Edit {offset} {
        ...
        $ext_cvName raise $sectArea_02
          ...
          #
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_x0     chainStayProfile_LengthComplete
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_x1     chainStayProfile_Length01
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_x2     chainStayProfile_Length02
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_x3     chainStayProfile_Length03
            #                                                           
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_c2     chainStayProfile_LengthCut
            #                                                           
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_w0     chainStayProfile_Width00
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_w1     chainStayProfile_Width01
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_w2     chainStayProfile_Width02
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_w3     chainStayProfile_Width03
            #
        return
            #
    ...
    proc rattleCAD::cv_custom::create_centerLine_Edit {ctrLines offset} {
        ...
        # set _dim_length_05        [ $ext_cvName dimension  length      [ appUtil::flatten_nestedList   $p8 $p9 ] \
                                            ...
                                            $ext_Colour(result) ]
            #
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_length_01     chainStayCenterline_Length01
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_length_02     chainStayCenterline_Length02
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_length_03     chainStayCenterline_Length03
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_length_04     chainStayCenterline_Length04
            #
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_obj_line_01       chainStayCenterline_Length01
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_obj_line_02       chainStayCenterline_Length02
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_obj_line_03       chainStayCenterline_Length03
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_obj_line_04       chainStayCenterline_Length04
            #
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $ctrlArea_01        chainStayCenterline_Bent01    
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $ctrlArea_02        chainStayCenterline_Bent02
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $ctrlArea_03        chainStayCenterline_Bent03
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $ctrlArea_04        chainStayCenterline_Bent04
            #
            #
