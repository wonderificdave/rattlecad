...
# 
    ...
    proc rattleCAD::control::get_lastValues {} {
        ...
        set _lastValue(Component/CrankSet/ChainRings)                           [rattleCAD::model::get_Scalar           CrankSet ChainRings               ]
        ...
        set _lastValue(Component/Fork/Crown/File)                               [rattleCAD::model::get_Component        Fork CrownFile                    ]
        set _lastValue(Component/Fork/DropOut/File)                             [rattleCAD::model::get_Component        Fork DropOutFile                  ]
        ...
        set _lastValue(Component/Stem/Angle)                                    [rattleCAD::model::get_Scalar           Stem Angle                        ]
        set _lastValue(Component/Stem/Length)                                   [rattleCAD::model::get_Scalar           Stem Length                       ]
        ...
        set _lastValue(Custom/BottomBracket/Depth)                              [rattleCAD::model::get_Scalar           BottomBracket Depth               ]
        ...
        set _lastValue(Custom/HeadTube/Angle)                                   [rattleCAD::model::get_Scalar           HeadTube Angle                    ]
        ...
        set _lastValue(Custom/TopTube/Angle)                                    [rattleCAD::model::get_Scalar           TopTube Angle                     ]
        ...
        set _lastValue(Custom/WheelPosition/Rear)                               [rattleCAD::model::get_Scalar           RearWheel DistanceBB              ]
        ...
        set _lastValue(FrameTubes/ChainStay/Profile/width_03)                   [rattleCAD::model::get_Scalar           ChainStay profile_y03             ]
        ...
        set _lastValue(Lugs/RearDropOut/File)                                   [rattleCAD::model::get_Component        RearDropout File                  ]
        ...
        set _lastValue(Personal/HandleBar_Distance)                             [rattleCAD::model::get_Scalar           HandleBar Distance                ]
        set _lastValue(Personal/HandleBar_Height)                               [rattleCAD::model::get_Scalar           HandleBar Height                  ]
        set _lastValue(Personal/InnerLeg_Length)                                [rattleCAD::model::get_Scalar           LegClearance Length               ]
        set _lastValue(Personal/Saddle_Distance)                                [rattleCAD::model::get_Scalar           Saddle Distance                   ]
        ...
        set _lastValue(Result/Length/BottomBracket/Height)                      [rattleCAD::model::get_Scalar           BottomBracket Height              ]
        set _lastValue(Result/Length/FrontWheel/Radius)                         [rattleCAD::model::get_Scalar           FrontWheel Radius                 ]
        ...
        set _lastValue(Result/Length/RearWheel/Radius)                          [rattleCAD::model::get_Scalar           RearWheel Radius                  ]
