 ...
 namespace eval rattleCAD::cv_custom {
    ...
    proc update_cv_Parameter {cv_Name BB_Position} {
            ...
            set SeatStay(SeatTube)          [ rattleCAD::model::get_Position    SeatStayEnd             $BB_Position ]
            set SeatStay(SeatTube)          [ rattleCAD::model::get_Position    SeatStayEnd             $BB_Position ]
            set TopTube(SeatTube)           [ rattleCAD::model::get_Position    TopTubeStart            $BB_Position ]
            set TopTube(Steerer)            [ rattleCAD::model::get_Position    TopTubeEnd              $BB_Position ]
            set HeadTube(Stem)              [ rattleCAD::model::get_Position    HeadTubeEnd             $BB_Position ]
            set HeadTube(Fork)              [ rattleCAD::model::get_Position    HeadTubeStart           $BB_Position ]
            set Steerer(Stem)               [ rattleCAD::model::get_Position    SteererEnd              $BB_Position ]
            set Steerer(Fork)               [ rattleCAD::model::get_Position    SteererStart            $BB_Position ]
            ...
            set SeatTube(TopTube)           [ rattleCAD::model::get_Position    SeatTubeEnd             $BB_Position ]
            set SeatTube(Saddle)            [ rattleCAD::model::get_Position    SeatTubeSaddle          $BB_Position ]
            set SeatTube(BBracket)          [ rattleCAD::model::get_Position    SeatTubeStart           $BB_Position ]
            set SeatStay(End)               [ rattleCAD::model::get_Position    SeatStayEnd             $BB_Position ]
            ...
            set Steerer(Start)          [ rattleCAD::model::get_Position        SteererStart    $BB_Position  ]
            set Steerer(End)            [ rattleCAD::model::get_Position        SteererEnd      $BB_Position  ]
                #
    ...
    proc get_BottomBracket_Position {cv_Name bottomCanvasBorder {updatePosition {recenter}} {option {bicycle}} {stageScale {}}} {
		...
		set FrontWheel(Position)      [rattleCAD::model::get_Scalar FrontWheel ]	
		set FrontWheel(RimDiameter)   [rattleCAD::model::get_Scalar FrontWheel RimDiameter ]
        set FrontWheel(TyreHeight)    [rattleCAD::model::get_Scalar FrontWheel TyreHeight ]
        ...
        set BottomBracketDepth        [ rattleCAD::model::get_Scalar BottomBracket Depth ]
    ...
    proc createCenterline {cv_Name BB_Position {extend_Saddle {}}} {
            ...
            set SeatTube(Saddle)            [ rattleCAD::model::get_Position    SeatTubeSaddle          $BB_Position ]
            set SeatTube(TopTube)           [ rattleCAD::model::get_Position    SeatTubeEnd             $BB_Position ]
            set SeatStay(RearWheel)         [ rattleCAD::model::get_Position    SeatStayStart           $BB_Position ]
            set TopTube(SeatTube)           [ rattleCAD::model::get_Position    TopTubeStart            $BB_Position ]
            set TopTube(Steerer)            [ rattleCAD::model::get_Position    TopTubeEnd              $BB_Position ]
            set Steerer(Stem)               [ rattleCAD::model::get_Position    SteererEnd              $BB_Position ]
            set Steerer(Fork)               [ rattleCAD::model::get_Position    SteererStart            $BB_Position ]
    ...
    proc createLugRep {cv_Name BB_Position {type {all}}} {
        ...
        # $cv_Name bind   $represent_DO       <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Lugs(RearDropOut/Angle/value)        Lugs(RearDropOut/Angle/plus_minus) }             {Lug Specification:  RearDropout}]
        # $cv_Name bind   $represent_BB_01    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Lugs(BottomBracket/DownTube/Angle/value)  Lugs(BottomBracket/DownTube/Angle/plus_minus) }     {Lug Specification:  Seat-/DownTube}]
        # $cv_Name bind   $represent_BB_02    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Lugs(BottomBracket/ChainStay/Angle/value) Lugs(BottomBracket/ChainStay/Angle/plus_minus) }    {Lug Specification:  SeatTube/ChainStay}]
        # $cv_Name bind   $represent_SL_01    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Lugs(SeatTube/TopTube/Angle/value)   Lugs(SeatTube/TopTube/Angle/plus_minus) }        {Lug Specification:  Seat-/TopTube}]
        # $cv_Name bind   $represent_SL_02    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Lugs(SeatTube/SeatStay/Angle/value)  Lugs(SeatTube/SeatStay/Angle/plus_minus) Lugs(SeatTube/SeatStay/MiterDiameter)}      {Lug Specification:  SeatTube/SeatStay}]
        # $cv_Name bind   $represent_HL_TT    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Lugs(HeadTube/TopTube/Angle/value)   Lugs(HeadTube/TopTube/Angle/plus_minus) }        {Lug Specification:  Top-/HeadTube}]
        # $cv_Name bind   $represent_HL_DT    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Lugs(HeadTube/DownTube/Angle/value)  Lugs(HeadTube/DownTube/Angle/plus_minus) }       {Lug Specification:  Head-/DownTube}]
