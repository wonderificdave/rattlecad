 ...
 namespace eval rattleCAD::rendering {
    ...
    proc rattleCAD::rendering::createBaseline {cv_Name BB_Position {colour {gray}}} {
            ...
            set BB_Ground(position)     [ rattleCAD::model::get_Position     BottomBracketGround  $BB_Position]
                # puts "   -> \$BB_Ground(position) $BB_Ground(position)"
                # exit
		    
            set RimDiameter_Front       [rattleCAD::model::get_Scalar   FrontWheel RimDiameter]
            set RimDiameter_Rear        [rattleCAD::model::get_Scalar   RearWheel  RimDiameter]
    ...
    proc rattleCAD::rendering::createDecoration_HandleBar {cv_Name BB_Position type {updateCommand {}}} {
            ...
            if {$updateCommand != {}}   { 
                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $HandleBar(object)      group_HandleBarParameter_99
            ...
            proc ::rattleCAD::view::edit::group_HandleBarParameter_99        {x y cv_Name} {  
    ...
    proc rattleCAD::rendering::createDecoration_DerailleurFront {cv_Name BB_Position type {updateCommand {}}} {
            ...
            if {$updateCommand != {}}   { 
                ...
                # rattleCAD::view::gui::object_CursorBinding     $cv_Name    $Derailleur(object)
                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $Derailleur(object)     group_DerailleurFrontParameter_17
            }
            proc ::rattleCAD::view::edit::group_DerailleurFrontParameter_17        {x y cv_Name} {
                    rattleCAD::view::createEdit  $x $y $cv_Name  { \
    ...
    proc rattleCAD::rendering::createDecoration_CrankSet {cv_Name BB_Position type {updateCommand {}}} {
            ...
            if {[file tail $CrankSet(file)] == {custom.svg}} {
                ...
                if {$updateCommand != {}}   { 
                    ...
                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $$CrankSet(object)      group_CranksetParameter_16
                }
                proc ::rattleCAD::view::edit::group_CranksetParameter_16        {x y cv_Name} {
                        rattleCAD::view::createEdit  $x $y $cv_Name  { \
    ...
    proc rattleCAD::rendering::createDecoration_Chain {cv_Name BB_Position type {updateCommand {}}} {
            ...
            if {$updateCommand != {}}   { 
                ...
                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $Chain(object)  group_ChainParameter_15
            }
            proc ::rattleCAD::view::edit::group_ChainParameter_15        {x y cv_Name} {
                    rattleCAD::view::createEdit  $x $y $cv_Name  { \
                            text://Component(CrankSet/ChainRings) \
                ...
                switch $Rendering(BrakeRear) {
                    Rim {
                            ...
                            if {$updateCommand != {}}   { 
                                ...
                                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $RearBrake(object)      group_RearBrakeParameter_14
                            }
                            proc ::rattleCAD::view::edit::group_RearBrakeParameter_14        {x y cv_Name} {
                                    rattleCAD::view::createEdit  $x $y $cv_Name  { \
                ...
                switch $Rendering(BrakeFront) {
                    Rim {
                            ...
                            if {$updateCommand != {}}   { 
                                ...
                                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $FrontBrake(object)     group_FrontBrakeParameter_13
                            }
                            proc ::rattleCAD::view::edit::group_FrontBrakeParameter_13        {x y cv_Name} {
                                    rattleCAD::view::createEdit  $x $y $cv_Name  { \
    ...
    proc rattleCAD::rendering::createDecoration_BottleCage {cv_Name BB_Position type {updateCommand {}}} {
            ...
            if {$Rendering(BottleCage_DT) != {off}} {
                ...
                set BottleCage(object)      [ $cv_Name readSVG $BottleCage(file) $bc_position $dt_angle  __BottleCage_DT__ ]
                                              $cv_Name addtag  __Decoration__ withtag $BottleCage(object)
                if {$updateCommand != {}}   { 
                    # $cv_Name bind $BottleCage(object)    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { list://Rendering(BottleCage/DownTube@SELECT_BottleCage) }   {BottleCage DownTube-Upper Parameter} ]
                    # rattleCAD::view::gui::object_CursorBinding     $cv_Name    $BottleCage(object)
    ...
    proc rattleCAD::rendering::createDecoration_Saddle {cv_Name BB_Position type {updateCommand {}}} {
            ...
            if {$updateCommand != {}}   { 
                # $cv_Name bind $Saddle(object)    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  {   file://Component(Saddle/File)  Component(Saddle/LengthNose)    Rendering(Saddle/Offset_X)    Rendering(Saddle/Offset_Y)    Result(Length/Saddle/Offset_BB_Nose) }   {Saddle Parameter} ]
                # rattleCAD::view::gui::object_CursorBinding     $cv_Name    $Saddle(object)
                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $Saddle(object)     group_SaddleParameter_12
            }
            proc ::rattleCAD::view::edit::group_SaddleParameter_12        {x y cv_Name} {
                    rattleCAD::view::createEdit  $x $y $cv_Name  { \
    ...
    proc rattleCAD::rendering::createDecoration_HeadSet {cv_Name BB_Position type {updateCommand {}}} {
            ...
            if {$updateCommand != {}}   { 
                # $cv_Name bind $HeadSet(object)    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  {   Component(HeadSet/Height/Top)  Component(HeadSet/Diameter) }  {HeadSet Parameter} ]
                # rattleCAD::view::gui::object_CursorBinding     $cv_Name    $HeadSet(object)
                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $HeadSet(object)      group_HeadSetParameter_10
            }
            proc ::rattleCAD::view::edit::group_HeadSetParameter_10        {x y cv_Name} {
                    rattleCAD::view::createEdit  $x $y $cv_Name  { \
            ...
            set HeadSet(object)         [ $cv_Name create polygon $HeadSet(polygon) -fill white -outline black  -tags __Decoration__ ]
            if {$updateCommand != {}}   { 
                # $cv_Name bind $HeadSet(object)    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  {   Component(HeadSet/Height/Bottom)   Component(HeadSet/Diameter) }  {HeadSet Parameter} ]
                # rattleCAD::view::gui::object_CursorBinding     $cv_Name    $HeadSet(object)
                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $HeadSet(object)    group_HeadSetParameter_09
            }
            proc ::rattleCAD::view::edit::group_HeadSetParameter_09        {x y cv_Name} {
                    rattleCAD::view::createEdit  $x $y $cv_Name  { \ 
    ...
    proc rattleCAD::rendering::createDecoration_Logo {cv_Name BB_Position type {updateCommand {}}} {
            ...
            if {$updateCommand != {}}   { 
                ...
                # $cv_Name bind $Logo(object)     <Double-ButtonPress-1> [list rattleCAD::view::createEdit  %x %y  $cv_Name  { file://Component(Logo/File) }   {Logo Parameter} ]
    ...
    proc rattleCAD::rendering::createDecoration_Fender {cv_Name BB_Position type {updateCommand {}}} {
            ...
            if {$Rendering(Fender_Rear) != {off}} { # --- create RearWheel Fender ----------
                ...
                if {$updateCommand != {}} {
                    # $cv_Name bind $RearFender(object) <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { list://Rendering(Fender/Rear@SELECT_Binary_OnOff) Component(Fender/Rear/Radius)   Component(Fender/Rear/Height)   Component(Fender/Rear/OffsetAngle)  }     {FrontFender Parameter} ]
                    # rattleCAD::view::gui::object_CursorBinding     $cv_Name    $RearFender(object)
                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $RearFender(object)      group_FrontFenderParameter_08
                }
                proc ::rattleCAD::view::edit::group_FrontFenderParameter_08        {x y cv_Name} {
                        rattleCAD::view::createEdit  $x $y $cv_Name  { \
            ...
            if {$Rendering(Fender_Front) != {off}} { # --- create FrontWheel Fender ----------
                ...
                if {$updateCommand != {}} { 
                    # $cv_Name bind    $FrontFender(object)    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { list://Rendering(Fender/Front@SELECT_Binary_OnOff)    Component(Fender/Front/Radius)  Component(Fender/Front/Height)  Component(Fender/Front/OffsetAngleFront)    Component(Fender/Front/OffsetAngle)}   {FrontWheel Parameter} ]
                    # rattleCAD::view::gui::object_CursorBinding     $cv_Name    $FrontFender(object)
                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $FrontFender(object)    group_FrontWheelParameter_03
                }
            }
            proc ::rattleCAD::view::edit::group_FrontWheelParameter_03        {x y cv_Name} {
                    rattleCAD::view::createEdit  $x $y $cv_Name  { \
    ...
    proc rattleCAD::rendering::createDecoration_CarrierFront {cv_Name BB_Position type {updateCommand {}}} {
            ...
            if {$updateCommand != {}}   { 
                    ...
                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $CarrierFront(object)   group_CarrierFrontParameter_07
            }
            proc ::rattleCAD::view::edit::group_CarrierFrontParameter_07        {x y cv_Name} {
                    rattleCAD::view::createEdit  $x $y $cv_Name  { \
    ...
    proc rattleCAD::rendering::createDecoration_CarrierRear {cv_Name BB_Position type {updateCommand {}}} {
            ...
            if {$updateCommand != {}}   { 
                    ...
                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $CarrierRear(object)      group_CarrierRearParameter_11
            }
            proc ::rattleCAD::view::edit::group_CarrierRearParameter_11        {x y cv_Name} {
                    rattleCAD::view::createEdit  $x $y $cv_Name  { \
    ...
    proc rattleCAD::rendering::createFrame_Tubes {cv_Name BB_Position {updateCommand {}}} {
        ...
        if {$updateCommand != {}}   { 
                ...
                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $DownTube(object)   group_DownTubeParameter_06
        }
        proc ::rattleCAD::view::edit::group_DownTubeParameter_06        {x y cv_Name} {
                rattleCAD::view::createEdit  $x $y $cv_Name  { \
        ...
        if {$updateCommand != {}}   { 
                ...
                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $SeatTube(object)   group_SeatTubeParameter_05
            }
            proc ::rattleCAD::view::edit::group_SeatTubeParameter_05        {x y cv_Name} {
                    rattleCAD::view::createEdit  $x $y $cv_Name  { \
        ...
        if {$updateCommand != {}}   { 
                ...
                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $TopTube(object)    group_TopTubeParameter_04
        }
        proc ::rattleCAD::view::edit::group_TopTubeParameter_04        {x y cv_Name} {
                rattleCAD::view::createEdit  $x $y $cv_Name  {
            ...
            # --- create Rear Dropout ----------------
        set RearWheel(position)     [ rattleCAD::model::get_Position    RearWheel           $BB_Position]
        set RearDropout(file)       [ checkFileString [rattleCAD::model::get_Component RearDropout File] ]
        set RearDropout(angle)      [ rattleCAD::model::get_Direction   RearDropout degree]
        set Rendering(RearDropOut)  [ rattleCAD::model::get_Option      RearDropout ]
            #
        ...
        if {$updateCommand != {}}   { 
                ...
                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $ChainStay(object)      group_ChainStayParameter_01
        }
        proc ::rattleCAD::view::edit::group_ChainStayParameter_01        {x y cv_Name} {
                rattleCAD::view::createEdit  $x $y $cv_Name  { \
        ...
        if {$updateCommand != {}}   { 
                ...
                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $SeatStay(object)   group_SeatStayParameter_01
        }
        proc ::rattleCAD::view::edit::group_SeatStayParameter_01        {x y cv_Name} {  
                rattleCAD::view::createEdit  $x $y $cv_Name  { \
                        Lugs(SeatTube/SeatStay/MiterDiameter) \
        ...
        if {$updateCommand != {}}   { 
                ...
                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $RearDropout(object)    group_RearDropoutParameter_01
            }
            proc ::rattleCAD::view::edit::group_RearDropoutParameter_01        {x y cv_Name} {  
                    rattleCAD::view::createEdit  $x $y $cv_Name  { \
        ...
        if {$updateCommand != {}}   { 
                rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    __BottomBracket__      group_BottomBracketDiameter_01
            ...
            proc ::rattleCAD::view::edit::group_BottomBracketDiameter_01       {x y cv_Name} {  
                    rattleCAD::view::createEdit  $x $y $cv_Name  { \
    ...
    proc rattleCAD::rendering::createCrank_Custom {cv_Name BB_Position} {
        ...
        variable teethCount     [lindex [lsort [split [rattleCAD::model::get_Scalar CrankSet ChainRings] -]] end]
    ...
    proc rattleCAD::rendering::createFork {cv_Name BB_Position {updateCommand {}} } {
        ...
        set tubeColour      "white"
            ...
            # --- get Rendering Style
        set Rendering(Fork)         [ rattleCAD::model::get_Option Fork]
        set Rendering(ForkBlade)    [ rattleCAD::model::get_Option ForkBlade]
        set Rendering(ForkDropOut)  [ rattleCAD::model::get_Option ForkDropout]
        ...
        switch -glob $Rendering(Fork) {
            SteelLugged {
                        ...
                        set do_direction            [ rattleCAD::model::get_Direction   Lugs/Dropout/Front ]
            ...
            Composite*    {
                        ...
                        set ForkDropout(file)       [ checkFileString $bikeGeometry::myFork(DropOutFile) ]
                        set ForkDropout(position)   [ rattleCAD::model::get_Position    FrontWheel      $BB_Position ]
                        set Steerer_Fork(position)  [ rattleCAD::model::get_Position    Lugs/ForkCrown  $BB_Position]
                        set ht_direction            [ rattleCAD::model::get_Direction   HeadTube ]
            ...
            Suspension* {
                        ...
                        set ForkCrown(file)         [ checkFileString $bikeGeometry::myFork(CrownFile) ]
                        set ForkDropout(file)       [ checkFileString $bikeGeometry::myFork(DropOutFile) ]
                        set Suspension_ForkRake     [ rattleCAD::model::get_Scalar Fork Rake ]
                        set Suspension_ForkRake     40
                        set Project_ForkRake        [ rattleCAD::model::get_Scalar Fork Rake]
        ...
        switch -exact $updateCommand {
            editable {
                    switch -glob $Rendering(Fork) {
                        SteelLugged {
                            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $ForkBlade(object)  group_ForkBladeParameter
                            # $cv_Name bind $ForkBlade(object)  <Double-ButtonPress-1> [list rattleCAD::view::createEdit  %x %y  $cv_Name  { list://Rendering(ForkBlade@SELECT_ForkBladeType) Component(Fork/Blade/Width) Component(Fork/Blade/DiameterDO)    Component(Fork/Blade/TaperLength)   Component(Fork/Blade/BendRadius)    Component(Fork/Blade/EndLength) }  {ForkBlade Parameter} ]
            ...
            selectable {            
                            ...
                            # $cv_Name bind $ForkBlade(object)  <Double-ButtonPress-1> [list rattleCAD::view::createEdit  %x %y  $cv_Name  { list://Rendering(Fork@SELECT_ForkType) }  {ForkType Select} ]
                            # rattleCAD::view::gui::object_CursorBinding     $cv_Name    $ForkBlade(object)
                }   
                default {}
        }                                                   
            ...
            # --- create ForkCrown -------------------
                set ht_direction    [ rattleCAD::model::get_Direction   Lugs/ForkCrown ]
                set ht_angle        [expr [ vectormath::dirAngle        {0 0}   $ht_direction ] -90 ]
        set ForkCrown(position)     [ rattleCAD::model::get_Position    Lugs/ForkCrown  $BB_Position ]
        set ForkCrown(object)       [ $cv_Name readSVG [file join $::APPL_Config(COMPONENT_Dir) $ForkCrown(file)] $ForkCrown(position) $ht_angle __ForkCrown__ ]
        ...
        switch -exact $updateCommand {
            editable {              
                    switch $Rendering(Fork) {
                        SteelLugged {            
                            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $ForkCrown(object)  group_ForkCrownParameter
                            # $cv_Name bind $ForkCrown(object)  <Double-ButtonPress-1>    [list rattleCAD::view::createEdit  %x %y  $cv_Name  { list://Rendering(Fork@SELECT_ForkType)    file://Component(Fork/Crown/File)   Component(Fork/Crown/Brake/Angle)   Component(Fork/Crown/Brake/Offset)  Component(Fork/Crown/Blade/Offset)  Component(Fork/Crown/Blade/OffsetPerp) }    {ForkCrown Parameter} ]
                        ...
                        default {            
                            ...
                            # $cv_Name bind $ForkCrown(object)  <Double-ButtonPress-1>    [list rattleCAD::view::createEdit  %x %y  $cv_Name  { list://Rendering(Fork@SELECT_ForkType) }  {ForkCrown Parameter} ]
                            # rattleCAD::view::gui::object_CursorBinding     $cv_Name    $ForkCrown(object)
                            }
                    }
                    # rattleCAD::view::gui::object_CursorBinding     $cv_Name    $ForkCrown(object)
            ...
            selectable {            
                            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $ForkCrown(object)  option_ForkType
                            # $cv_Name bind $ForkCrown(object)  <Double-ButtonPress-1>    [list rattleCAD::view::createEdit  %x %y  $cv_Name  { list://Rendering(Fork@SELECT_ForkType) }  {ForkType Select} ]
                            # rattleCAD::view::gui::object_CursorBinding     $cv_Name    $ForkCrown(object)
                }
            default {}
        }
        ...
        switch -exact $updateCommand {
            editable { if {$Rendering(Fork) == {SteelLugged}} {           
                            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $ForkDropout(object)  group_ForkDropoutParameter
                            # $cv_Name bind $ForkDropout(object)  <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { file://Component(Fork/DropOut/File)   list://Rendering(ForkDropOut@SELECT_DropOutPosition)    Component(Fork/DropOut/Offset)  Component(Fork/DropOut/OffsetPerp) }  {ForkDropout Parameter} ]
    ...
    proc rattleCAD::rendering::createChain {cv_Name BB_Position} {
        set crankWheelTeethCount     [lindex [lsort [split [rattleCAD::model::get_Scalar CrankSet ChainRings] -]] end]
    ...
    proc rattleCAD::rendering::createFrame_Centerline {cv_Name BB_Position {highlightList_1 {}} {highlightList_2 {}} {backgroundList {}} {excludeList {}} } {
            ...
            set SeatPost_SeatTube   [ rattleCAD::model::get_Position          SeatPostSeatTube        $BB_Position ]
            set SeatPost_Pivot      [ rattleCAD::model::get_Position          SeatPostPivot           $BB_Position ]
            set SeatTube_Ground     [ rattleCAD::model::get_Position          SeatTubeGround          $BB_Position ]
            set SeatTube_BBracket   [ rattleCAD::model::get_Position          SeatTube/Start          $BB_Position ]
            set SeatStay_SeatTube   [ rattleCAD::model::get_Position          SeatStay/End            $BB_Position ]
            set SeatStay_RearWheel  [ rattleCAD::model::get_Position          SeatStay/Start          $BB_Position ]
            set TopTube_SeatTube    [ rattleCAD::model::get_Position          TopTube/Start           $BB_Position ]
            set TopTube_Steerer     [ rattleCAD::model::get_Position          TopTube/End             $BB_Position ]
            set HeadTube_Stem       [ rattleCAD::model::get_Position          HeadTube/End            $BB_Position ]
            set Steerer_Stem        [ rattleCAD::model::get_Position          Steerer/End             $BB_Position ]
            set Steerer_Fork        [ rattleCAD::model::get_Position          Steerer/Start           $BB_Position ]
            set DownTube_Steerer    [ rattleCAD::model::get_Position          DownTube/End            $BB_Position ]
            set HandleBar           [ rattleCAD::model::get_Position          HandleBar               $BB_Position ]
            set BaseCenter          [ rattleCAD::model::get_Position          BottomBracketGround     $BB_Position ]
            ...
            set RimDiameter_Front   [rattleCAD::model::get_Scalar FrontWheel RimDiameter]
            set TyreHeight_Front    [rattleCAD::model::get_Scalar FrontWheel TyreHeight]
            set RimDiameter_Rear    [rattleCAD::model::get_Scalar RearWheel RimDiameter]
            set TyreHeight_Rear     [rattleCAD::model::get_Scalar RearWheel TyreHeight]
            ...
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    bottombracket   group_BottomBracketDepthHeight
    ...
    proc rattleCAD::rendering::createTubemiter {cv_Name xy type {rotation {no}}} {
        ...
        switch $type {
            TopTube_Head {
                    ...
                    set     polygon             [ rattleCAD::model::get_Polygon     TubeMiter/TopTube_Head          {0 0} ]
            ...
            TopTube_Seat {
                    ...
                    set     polygon             [ rattleCAD::model::get_Polygon     TubeMiter/TopTube_Seat          {0 0} ]
            ...
            DownTube_Head {
                    ...
                    set     polygon             [ rattleCAD::model::get_Polygon     TubeMiter/DownTube_Head         {0 0} ]
                    set     majorDiameter       [ rattleCAD::model::get_Scalar      HeadTube    Diameter]
                    set     majorDirection      [ rattleCAD::model::get_Direction   HeadTube ]
            ...
            DownTube_Seat {
                    ...
                    set     polygon             [ rattleCAD::model::get_Polygon     TubeMiter/DownTube_Seat         {0 0} ]
                    set     polygon_out         [ rattleCAD::model::get_Polygon     TubeMiter/DownTube_BB_out       {0 0} ]
                    set     polygon_in          [ rattleCAD::model::get_Polygon     TubeMiter/DownTube_BB_in        {0 0} ]
            ...
            SeatTube_Down {
                    ...
                    set     polygon             [ rattleCAD::model::get_Polygon     TubeMiter/SeatTube_Down         {0 0} ]
                    set     polygon_out         [ rattleCAD::model::get_Polygon     TubeMiter/SeatTube_BB_out       {0 0} ]
                    set     polygon_in          [ rattleCAD::model::get_Polygon     TubeMiter/SeatTube_BB_in        {0 0} ]
            ...
            SeatStay_01 {
                    ...
                    set     polygon             [ rattleCAD::model::get_Polygon     TubeMiter/SeatStay_01           {0 0} ]
            ...
            SeatStay_02 {
                    set Miter(header)       "SeatStay / SeatTube"
                    set     polygon             [ rattleCAD::model::get_Polygon     TubeMiter/SeatStay_02           {0 0} ]
                    set     majorDiameter       [ rattleCAD::model::get_Scalar      SeatStay    SeatTubeMiterDiameter ]
                    set     majorDirection      [ rattleCAD::model::get_Direction   SeatTube ]
                    set     minorDiameter       [ rattleCAD::model::get_Scalar      SeatStay    DiameterST ]
                    set     minorDirection      [ rattleCAD::model::get_Direction   SeatStay ]
            ...
            Reference {
                    ...
                    set       polygon           [ rattleCAD::model::get_Polygon     TubeMiter/Reference             {0 0} ]
                }
            default {return}
        }
        ...
        switch $type {
            ...
            default {                   
                        ...
                        if {$rotation == {no}} {                
                                set pt_03   [ rattleCAD::model::coords_get_xy $Miter(polygon) end ]
                                    # puts "\$Miter(polygon) $Miter(polygon)"
                                    # puts "\$pt_03 $pt_03"
                                set pt_03   [ vectormath::addVector $pt_03 {+5  20} ]
                                set pt_04   [ rattleCAD::model::coords_get_xy $Miter(polygon) end-1]
