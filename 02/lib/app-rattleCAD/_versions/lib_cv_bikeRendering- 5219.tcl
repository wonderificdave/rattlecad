 ...
 namespace eval rattleCAD::rendering {
    ...
    proc rattleCAD::rendering::createDecoration_Logo {cv_Name BB_Position type {updateCommand {}}} {
                # --- create Logo --------------------
            set DownTube(Steerer)       [ rattleCAD::model::get_Position           DownTubeEnd         $BB_Position ]
            set DownTube(BBracket)      [ rattleCAD::model::get_Position           DownTubeStart       $BB_Position ]
    ...
    proc rattleCAD::rendering::createFork {cv_Name BB_Position {updateCommand {}} } {
        ...
        switch -glob $Rendering(Fork) {
            ...
            Composite*    {
                        ...
                        set ForkDropout(file)       [ checkFileString [rattleCAD::model::get_Component  Fork    DropOutFile] ]
                        set ForkDropout(position)   [ rattleCAD::model::get_Position    FrontWheel      $BB_Position ]
                        set Steerer_Fork(position)  [ rattleCAD::model::get_Position    ForkCrown       $BB_Position]
                        set ht_direction            [ rattleCAD::model::get_Direction   HeadTube ]
    ...
    proc rattleCAD::rendering::createFrame_Centerline {cv_Name BB_Position {highlightList_1 {}} {highlightList_2 {}} {backgroundList {}} {excludeList {}} } {
            ...
            set SeatTube_BBracket   [ rattleCAD::model::get_Position          SeatTubeStart           $BB_Position ]
            set SeatStay_SeatTube   [ rattleCAD::model::get_Position          SeatStayEnd             $BB_Position ]
            set SeatStay_RearWheel  [ rattleCAD::model::get_Position          SeatStayStart           $BB_Position ]
            set TopTube_SeatTube    [ rattleCAD::model::get_Position          TopTubeStart            $BB_Position ]
            set TopTube_Steerer     [ rattleCAD::model::get_Position          TopTubeEnd              $BB_Position ]
            set HeadTube_Stem       [ rattleCAD::model::get_Position          HeadTubeEnd             $BB_Position ]
            set Steerer_Stem        [ rattleCAD::model::get_Position          SteererEnd              $BB_Position ]
            set Steerer_Fork        [ rattleCAD::model::get_Position          SteererStart            $BB_Position ]
            set DownTube_Steerer    [ rattleCAD::model::get_Position          DownTubeEnd             $BB_Position ]
