...
namespace eval rattleCAD::view {
    ...
    proc rattleCAD::view::create_Config_old {cv cv_Name cvEdit cvContentFrame index key} {
        variable _updateValue
            # appUtil::get_procHierarchy
    ...
    proc rattleCAD::view::create_ValueEdit_old {cv cv_Name cvEdit cvContentFrame index labelText key} {
    ...
    proc rattleCAD::view::create_TextEdit_old {cv cv_Name cvEdit cvContentFrame index labelText key} {
    ...
    proc rattleCAD::view::create_ListEdit_old {type cv cv_Name cvEdit cvContentFrame index labelText key} {
