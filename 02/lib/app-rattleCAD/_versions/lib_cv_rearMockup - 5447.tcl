    ...
    proc rattleCAD::cv_custom::createRearMockup {cv_Name} {
            ...
            switch [rattleCAD::model::get_Config ChainStay] {
                   ...
                   {bent}     { set ChainStay(start)           [rattleCAD::model::get_Position ChainStay_RearMockup]
                                ...
                                set ChainStay(centerLine)      [format_XspaceY [rattleCAD::model::get_CenterLine CenterLine RearMockup]]
                                set ChainStay(centerLineUnCut) [format_XspaceY [rattleCAD::model::get_CenterLine CenterLine RearMockup_UnCut]]
                                    # 
