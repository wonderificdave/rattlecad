 ...
 #
    ...
    proc rattleCAD::cv_custom::createDimension_Geometry_BG_Lug      {cv_Name BB_Position type} {
                # geometry_bg
                #
            variable    stageScale
                #
    ...
    proc rattleCAD::cv_custom::createDimension_Geometry_FG_Lug      {cv_Name BB_Position type active} {
            variable    stageScale
