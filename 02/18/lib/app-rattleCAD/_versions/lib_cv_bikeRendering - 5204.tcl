 ...
 namespace eval rattleCAD::rendering {
    ...
    proc rattleCAD::rendering::createDecoration_Fender {cv_Name BB_Position type {updateCommand {}}} {
                #
            set Rendering(Fender_Front)     [rattleCAD::model::get_Config FrontFender]
            set Rendering(Fender_Rear)      [rattleCAD::model::get_Config RearFender]                
                # --- create Fender ------------------
    ...
    proc rattleCAD::rendering::createFrame_Tubes {cv_Name BB_Position {updateCommand {}}} {
        ...
        set Rendering(RearDropOut)  [ rattleCAD::model::get_Config      RearDropout ]
            #
    ...
    proc rattleCAD::rendering::createFork {cv_Name BB_Position {updateCommand {}} } {
        ...
        set tubeColour      "white"
            ...
            # --- get Rendering Style
        set Rendering(Fork)         [ rattleCAD::model::get_Config Fork]
        set Rendering(ForkBlade)    [ rattleCAD::model::get_Config ForkBlade]
        set Rendering(ForkDropOut)  [ rattleCAD::model::get_Config ForkDropout]
        ...
        switch -glob $Rendering(Fork) {
            SteelLugged {
                        ...
                        set ForkCrown(file)         [ checkFileString [rattleCAD::model::get_Component  Fork    CrownFile]   ]
                        set ForkDropout(file)       [ checkFileString [rattleCAD::model::get_Component  Fork    DropOutFile] ]
