 ...
 namespace eval rattleCAD::rendering {
            ...
            switch $type {
                    ...
                    CrankSet {
                            ...
                            if {[file tail $CrankSet(file)] == {custom.svg}} {
                                    ...
                                    if {$updateCommand != {}}   { $cv_Name bind    $CrankSet(object)    <Double-ButtonPress-1> \
                                                                            [list rattleCAD::view::createEdit  %x %y  $cv_Name                                                                           {   file://Component(CrankSet/File)                                                                              Component(CrankSet/Length)                                                                              text://Component(CrankSet/ChainRings)
                                                                                            }   {Crankset:  Parameter}
                                                                            ]
                    ...
                    BottleCage {
                                ...
                                if {$Rendering(BottleCage_ST) != {off}} {
                                            ...
                                            if {$updateCommand != {}}   { $cv_Name bind    $BottleCage(object)    <Double-ButtonPress-1>                                                                  [list rattleCAD::view::createEdit  %x %y  $cv_Name                                                                                   {   list://Rendering(BottleCage/SeatTube@SELECT_BottleCage)                                                                                  }   {BottleCage SeatTube Parameter} \
                                                                                    ]
                    ...
                    RearWheel {     # --- create RearWheel -----------------
                            ...
                            if {$updateCommand != {}}   { $cv_Name bind $my_Rim <Double-ButtonPress-1> \
                                                                    [list rattleCAD::view::createEdit  %x %y  $cv_Name                                                                   {     Component(Wheel/Rear/RimHeight)                                                                         }     {RearWheel Parameter} \
                                                                    ]
                    ...
                    FrontWheel {    # --- create FrontWheel ----------------
                            ...
                            if {$updateCommand != {}}   { 
                                    #rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $my_Rim     option_ForkType    
    ...
    proc rattleCAD::rendering::createFrame_Tubes {cv_Name BB_Position {updateCommand {}}} {
        ...
        if {$updateCommand != {}}   { $cv_Name bind    $HeadTube(object)   <Double-ButtonPress-1> \
                                                    [list rattleCAD::view::createEdit  %x %y  $cv_Name                                                   {   FrameTubes(HeadTube/Diameter)                                                     }  {HeadTube Parameter}
                                                    ]
        ...
        if {$updateCommand != {}}   { $cv_Name bind    $DownTube(object)    <Double-ButtonPress-1> \
                                                    [list rattleCAD::view::createEdit  %x %y  $cv_Name                                                   {   FrameTubes(DownTube/DiameterHT)                                                       FrameTubes(DownTube/DiameterBB)                                                       FrameTubes(DownTube/TaperLength)                                                  }  {DownTube Parameter}
                                                    ]
        ...
        if {$updateCommand != {}}   { $cv_Name bind    $SeatTube(object)   <Double-ButtonPress-1> \
                                                    [list rattleCAD::view::createEdit  %x %y  $cv_Name                                                   {   Lugs(SeatTube/SeatStay/MiterDiameter)                                                      FrameTubes(SeatTube/DiameterTT)                                                        FrameTubes(SeatTube/DiameterBB)                                                        FrameTubes(SeatTube/TaperLength)                                                   }  {SeatTube Parameter}
                                                    ]
        ...
        if {$updateCommand != {}}   { $cv_Name bind    $TopTube(object)    <Double-ButtonPress-1> \
                                                    [list rattleCAD::view::createEdit  %x %y  $cv_Name                                                   {   FrameTubes(TopTube/DiameterHT)                                                        FrameTubes(TopTube/DiameterST)                                                        FrameTubes(TopTube/TaperLength)                                                       Custom(TopTube/Angle)                                                         }  {TopTube Parameter}
                                                    ]
        ...
        if {$updateCommand != {}}   { $cv_Name bind    $ChainStay(object)    <Double-ButtonPress-1> \
                                                    [list rattleCAD::view::createEdit  %x %y  $cv_Name                                                   {   FrameTubes(ChainStay/DiameterSS)                                                           FrameTubes(ChainStay/Height)                                                         FrameTubes(ChainStay/HeightBB)                                                       FrameTubes(ChainStay/TaperLength)                                                        Lugs(RearDropOut/ChainStay/OffsetPerp)                                                       Lugs(RearDropOut/ChainStay/Offset)                                                   }  {ChainStay Parameter}
                                                    ]
        ...
        if {$updateCommand != {}}   { $cv_Name bind    $SeatStay(object)    <Double-ButtonPress-1> \
                                                    [list rattleCAD::view::createEdit  %x %y  $cv_Name                                                   {   Lugs(SeatTube/SeatStay/MiterDiameter)                                                      FrameTubes(SeatStay/DiameterST)                                                        FrameTubes(SeatStay/DiameterCS)                                                        FrameTubes(SeatStay/TaperLength)                                                       Custom(SeatStay/OffsetTT)                                                        Lugs(RearDropOut/SeatStay/OffsetPerp)                                                        Lugs(RearDropOut/SeatStay/Offset)                                                    }  {SeatStay Parameter}
                                                    ]
        ...
        if {$updateCommand != {}}   { $cv_Name bind    __BottomBracket__    <Double-ButtonPress-1> \
                                                    [list rattleCAD::view::createEdit  %x %y  $cv_Name                                                   {   Lugs(BottomBracket/Diameter/outside)                                                        Lugs(BottomBracket/Diameter/inside))                                                    }  {BottomBracket Diameter}
                                                    ]
    ...
    proc rattleCAD::rendering::createFrame_Centerline {cv_Name BB_Position {highlightList_1 {}} {highlightList_2 {}} {backgroundList {}} {excludeList {}} } {
            ...
            $cv_Name bind  bottombracket  <Double-ButtonPress-1>  \
                    [list rattleCAD::view::createEdit  %x %y  $cv_Name               {   Custom(BottomBracket/Depth)                  Result(Length/BottomBracket/Height) } {BottomBracket:  Settings}]
