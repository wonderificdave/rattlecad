    ...
    proc rattleCAD::cv_custom::createRearMockup {cv_Name} {
            ...
            switch [rattleCAD::model::get_Config ChainStay] {
                   ...
                   {bent}     { set ChainStay(start)           [rattleCAD::model::get_Position ChainStayRearMockup]
                                ...
                                set ChainStay(ctrLines)        [format_XspaceY [rattleCAD::model::get_CenterLine RearMockup CtrLines]]
                                set ChainStay(centerLine)      [format_XspaceY [rattleCAD::model::get_CenterLine RearMockup CenterLine]]
                                set ChainStay(centerLineUnCut) [format_XspaceY [rattleCAD::model::get_CenterLine RearMockup CenterLineUnCut]]
                                    # 
