 ...
 # 
    ...
    proc rattleCAD::cv_custom::createRearMockup {cv_Name} {
            ...
            set Length(ChainStay)           [rattleCAD::model::get_Scalar RearWheel DistanceBB]
            ...
            set Length(06)              [ expr 0.5 * [rattleCAD::model::get_Scalar RearWheel RimDiameter] + [rattleCAD::model::get_Scalar RearWheel TyreHeight] - [rattleCAD::model::get_Scalar RearWheel TyreWidthRadius]]
            ...
            set Center(Tyre)            [ vectormath::addVector $Center(RearHub)    [ list [expr 0.5 * ([rattleCAD::model::get_Scalar RearWheel RimDiameter] + [rattleCAD::model::get_Scalar RearWheel TyreHeight])] 0 ] ]
            set Center(Rim)             [ vectormath::addVector $Center(RearHub)    [ list [expr 0.5 *  [rattleCAD::model::get_Scalar RearWheel RimDiameter]] 0 ] ]
            set Center(TyreWidth)       [ vectormath::addVector $Center(RearHub)    [ list [rattleCAD::model::get_Scalar RearWheel TyreWidthRadius] 0 ] ]
            set Center(Dim_WheelRadius) [ vectormath::addVector $Center(Tyre)       [ list [expr 0.5 * [rattleCAD::model::get_Scalar RearWheel TyreHeight]] 0 ] ]
            ...
            $cv_Name create rectangle   $BB_OutSide   -outline blue     -fill $rattleCAD::view::colorSet(chainStay_1)  -width 1.0  -tags __Lug__
                ...
                # -- ChainStay Type
            switch [rattleCAD::model::get_Option ChainStay] {
                   {straight}   -
                   {bent}       -
                   {off}        {}
                   default      { puts "\n  <W> ... not defined in createRearMockup: [rattleCAD::model::get_Option ChainStay]\n"
                                  # return
                                }
            }
                # -- format Values
            ...
            switch [rattleCAD::model::get_Option ChainStay] {
                   {straight}   -
                   {bent}     { set ChainStay(start)           [rattleCAD::model::get_Position ChainStayRearMockup]
                                set ChainStay(polygon)         [rattleCAD::model::get_Polygon  ChainStayRearMockup {0 0}]
                                set ChainStay(ctrLines)        [format_XspaceY [rattleCAD::model::get_toRefactor RearMockup CtrLines]]
                                set ChainStay(centerLine)      [format_XspaceY [rattleCAD::model::get_toRefactor RearMockup CenterLine]]
                                set ChainStay(centerLineUnCut) [format_XspaceY [rattleCAD::model::get_toRefactor RearMockup CenterLineUnCut]]
                                    # 
                                ...
                                #$cv_Name bind   $tube_CS_CLine    <Double-ButtonPress-1>      [list rattleCAD::view::createEdit  %x %y  $cv_Name  { list://Rendering(ChainStay@SELECT_ChainStay) } {ChainStay:  CenterLine}]                               
                                #$cv_Name bind   $tube_CS_left     <Double-ButtonPress-1>      [list rattleCAD::view::createEdit  %x %y  $cv_Name  { list://Rendering(ChainStay@SELECT_ChainStay) } {ChainStay:  Type}]
                                #$cv_Name bind   $tube_CS_right    <Double-ButtonPress-1>      [list rattleCAD::view::createEdit  %x %y  $cv_Name  { list://Rendering(ChainStay@SELECT_ChainStay) } {ChainStay:  Type}]
                              }
            ...
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $brakeDisc       rearDiscBrake
                #rattleCAD::view::gui::object_CursorBinding   $cv_Name    $brakeDisc
                #$cv_Name bind   $brakeDisc    <Double-ButtonPress-1>        [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Rendering(RearMockup/DiscDiameter)    Rendering(RearMockup/DiscWidth) Rendering(RearMockup/DiscClearance) }   {DiscBrake Details}]
            ...
            switch -exact [rattleCAD::model::get_Option ChainStay] {
            ...
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_Tyre_Width        single_RearWheelTyreWidth
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_Tyre_Radius       single_RearWheelTyreWidthRadius
            ...
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_CS_Length         single_RearWheelDistance
            ...
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_BB_Diam_inside    single_BottomBracketInsideDiameter       
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_BB_Diam_outside   single_BottomBracketOutsideDiameter   
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_BB_Width          single_BottomBracketWidth  
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_CS_BB_Offset      single_BottomBracketChainStayOffset_TopView   
            ...
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_BrakeDisc_Dist_Hub    single_RearHubDiscOffset      
            ...
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_Hub_Width         single_RearHubWidth      
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_CS_DO_Distance    single_RearDropOutChainStayOffset    
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_CS_DO_Offset      single_RearDropOutChainStayOffset_TopView       
            ...
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_Crank_Length      single_CrankSetLength        
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_PedalEye          single_CrankSetPedalEye    
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_Crank_Q_Factor    single_CrankSetQFactor        
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_CrankArmWidth     single_CrankSetArmWidth    
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_ChainLine         single_CrankSetChainLine
    ...
    proc rattleCAD::cv_custom::create_Tyre {} {
            ...
            rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_tyreObj   rearTyreParameter
    ...
    proc rattleCAD::cv_custom::create_RearHub {} {   
            ...
            rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName $hubRep         group_RearHubParameter
            ...
            rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName $sprocketRep    single_RearHubFirstSprocket
    ...
    proc rattleCAD::cv_custom::create_CrankArm {} {
            ...
            rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName $componentCrank     group_CranksetParameter
            ...
            set list_ChainRings     [lsort [split [rattleCAD::model::get_Scalar CrankSet ChainRings] -]]
    ...
    proc rattleCAD::cv_custom::create_ClearArea {} {
            ...
            rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName    $chainstayArea   group_ChainStayArea
    ...
    proc rattleCAD::cv_custom::create_tubeProfile_Edit {offset} {
        ...
        $ext_cvName raise $sectArea_02
          ...
          #
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_x0     single_ChainStayProfile_LengthComplete
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_x1     single_ChainStayProfile_Length01
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_x2     single_ChainStayProfile_Length02
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_x3     single_ChainStayProfile_Length03
            #                                                           
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_c2     single_ChainStayProfile_LengthCut
            #                                                           
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_w0     single_ChainStayProfile_Width00
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_w1     single_ChainStayProfile_Width01
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_w2     single_ChainStayProfile_Width02
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_w3     single_ChainStayProfile_Width03
            #
        return
            #
    ...
    proc rattleCAD::cv_custom::create_centerLine_Edit {ctrLines offset} {
        ...
        # set _dim_length_05        [ $ext_cvName dimension  length      [ appUtil::flatten_nestedList   $p8 $p9 ] \
                                            ...
                                            $ext_Colour(result) ]
            #
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_length_01     single_ChainStayCenterline_Length01
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_length_02     single_ChainStayCenterline_Length02
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_length_03     single_ChainStayCenterline_Length03
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_dim_length_04     single_ChainStayCenterline_Length04
            #
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_obj_line_01       single_ChainStayCenterline_Length01
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_obj_line_02       single_ChainStayCenterline_Length02
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_obj_line_03       single_ChainStayCenterline_Length03
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $_obj_line_04       single_ChainStayCenterline_Length04
            #
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $ctrlArea_01        group_ChainStayCenterline_Bent01    
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $ctrlArea_02        group_ChainStayCenterline_Bent02
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $ctrlArea_03        group_ChainStayCenterline_Bent03
        rattleCAD::view::gui::dimension_CursorBinding   $ext_cvName     $ctrlArea_04        group_ChainStayCenterline_Bent04
            #
            #
