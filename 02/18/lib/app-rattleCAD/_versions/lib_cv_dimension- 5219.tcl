 ...
 #
    ...
    proc rattleCAD::cv_custom::createDimension_FrameDrafting_BG     {cv_Name BB_Position type} {
            ...
            set _dim_Fork_Height        [ $cv_Name dimension  length            [ appUtil::flatten_nestedList            $Steerer(vct_Bottom) $FrontWheel(Position)  ] \
                ...
                # -- Steerer Details ----------------------
                set pt_01               [ rattleCAD::model::get_Position   SteererStart     $BB_Position  ]
                set pt_02               [ rattleCAD::model::get_Position   SteererEnd       $BB_Position  ]
           ...
           set _dim_HeadTube_Angle      [ $cv_Name dimension  angle            [ appUtil::flatten_nestedList [list $pt_01 $Steerer(Stem) $pt_02] ] \
            ...
            set _dim_SeatTube_Extension [ $cv_Name dimension  length            [ appUtil::flatten_nestedList [list $pt_01 $pt_02] ] \
                ...
                set pt_01               [ rattleCAD::model::get_Position TopTubeStart   $BB_Position  ]
                set pt_02               [ rattleCAD::model::get_Position SeatStayEnd    $BB_Position  ]
            ...
            if { $DownTube(OffsetBB) != 0 } {
                    set pt_01           [ rattleCAD::model::get_Position    DownTubeEnd     $BB_Position  ]
                    set pt_02           [ rattleCAD::model::get_Position    DownTubeStart   $BB_Position  ]
            ...
            if { $SeatTube(OffsetBB) != 0 } {
                    set pt_01           [ rattleCAD::model::get_Position    SeatTubeEnd    $BB_Position  ]
                    set pt_02           [ rattleCAD::model::get_Position    SeatTubeStart  $BB_Position  ]
                    set pt_03           $BB_Position
                    if { [lindex $pt_02 1] >= [lindex $pt_03 1] } {
                            set dim_distance    [expr -70 * $stageScale]
                            set dim_offset      [expr -50 * $stageScale]
                ...
                set pt_01               [ rattleCAD::model::get_Position    TopTubeEnd     $BB_Position  ]
                set pt_hlp              [ rattleCAD::model::get_Position    TopTubeStart   $BB_Position  ]
            ...
            set _dim_TopTube_Angle      [ $cv_Name dimension  angle            [ appUtil::flatten_nestedList [list $pt_cnt $pt_02 $pt_01] ] \
                ...
                set pt_01               [ rattleCAD::model::get_Position    HeadTubeStart  $BB_Position  ]
                set pt_02               [ rattleCAD::model::get_Position    SteererStart   $BB_Position  ]
