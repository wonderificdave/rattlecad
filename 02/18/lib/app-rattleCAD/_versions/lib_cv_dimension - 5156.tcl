            ...
            switch $type {
                ...
                geometry_fg {
                            ...
                            if {$active == {on}} {
                                    ...
                                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_BB_Height   bottomBracketHeight
                                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_RW_Radius   rearWheelParameter
            ...
            switch $type {
                HeadTube_Length {
                            set dimension       [ $cv_Name dimension  length            [ appUtil::flatten_nestedList [lindex $HeadTube(vct_Top) 1] [lindex $HeadTube(vct_Bottom) 1] ] \
                                                                                    ...
                                                                                    darkred ]
                            if {$updateCommand != {}} { 
                                        $cv_Name    bind    $dimension    <Double-ButtonPress-1>  \
                                                                            [list rattleCAD::view::createEdit  %x %y  $cv_Name      { FrameTubes(HeadTube/Length) } {HeadTube Length}]
                ...
                HeadTube_OffsetTT {
                            ...
                            if {$updateCommand != {}} { $cv_Name    bind    $dimension    <Double-ButtonPress-1>  \
                                                                            [list rattleCAD::view::createEdit  %x %y  $cv_Name      { Custom(TopTube/OffsetHT ) }   {HeadTube TopTube Offset}]
                                                        rattleCAD::view::gui::object_CursorBinding        $cv_Name    $dimension
                                    }
                            }
                HeadTube_OffsetDT {
                ...
                BottleCage {
                            ...
                            if {$Rendering(BottleCage_DT_L) != {off}} {
                                            ...
                                            if {$updateCommand != {}} {    $cv_Name    bind    $dimension    <Double-ButtonPress-1>  \
                                                        rattleCAD::view::gui::object_CursorBinding        $cv_Name    $dimension
                                                        [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Component(BottleCage/DownTube_Lower/OffsetBB) }   {BottleCage DownTube Lower Offset}]
                ...
                DerailleurMount {
                            ...
                            set dimension_04    [ $cv_Name dimension  length    [ appUtil::flatten_nestedList   $pt_03 $pt_01 $pt_02 ] \
							    ...
							    #																								
                            if {$updateCommand != {}} { 
                                        rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $dimension_01   rearDerailleurMount
                                        rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $dimension_02   rearDerailleurMount
                ...
                check_this {
                            ...
                            if {$updateCommand != {}} {
                                        rattleCAD::view::gui::object_CursorBinding        $cv_Name    $dimension
                                        $cv_Name bind   $dimension      <Double-ButtonPress-1>  \
                                                [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Custom(SeatStay/OffsetTT) }   {SeatStay OffsetTopTube}]
