 ...
 #
    ...
    proc rattleCAD::cv_custom::createDimension {cv_Name BB_Position type {active {on}}} {
            ...
            variable    Vector
                ...
                # --- create dimension -------------------
            switch $type {
                point_center {          rattleCAD::cv_custom::createDimension_PointCenter       $cv_Name $BB_Position $type $active; return
                            
                            $cv_Name create circle        $Position(BaseCenter)     -radius 10  -outline gray50     -width 1.0  -tags __CenterLine__
                        }
                point_personal {        rattleCAD::cv_custom::createDimension_PointPersonal     $cv_Name $BB_Position $type $active; return
                ...
                point_crank {           rattleCAD::cv_custom::createDimension_PointCrank        $cv_Name $BB_Position $type $active; return
                ...
                point_reference {       rattleCAD::cv_custom::createDimension_PointReference    $cv_Name $BB_Position $type $active; return
                ...
                point_seat {            rattleCAD::cv_custom::createDimension_PointSeat         $cv_Name $BB_Position $type $active; return
                ...
                point_frame {           rattleCAD::cv_custom::createDimension_PointFrame        $cv_Name $BB_Position $type $active; return
                ...
                point_frame_dimension { rattleCAD::cv_custom::createDimension_CLineFrame       $cv_Name $BB_Position $type $active; return
                            
                            $cv_Name create circle        $HeadTube(Stem)           -radius  4  -outline gray       -width 1.0  -tags __CenterLine__
                        }
                cline_frame {           rattleCAD::cv_custom::createDimension_PointCenter       $cv_Name $BB_Position $type $active; return
                ...
                cline_angle {           rattleCAD::cv_custom::createDimension_CLineAngle        $cv_Name $BB_Position $type $active; return
                ...
                cline_brake {           rattleCAD::cv_custom::createDimension_CLineBrake        $cv_Name $BB_Position $type $active; return
                ...
                cline_framejig {        rattleCAD::cv_custom::createDimension_CLine_FrameJig        $cv_Name $BB_Position $type $active; return
                ...
                geometry_bg {           rattleCAD::cv_custom::createDimension_Geometry_BG           $cv_Name $BB_Position $type $active; return
    ...
    proc rattleCAD::cv_custom::createDimension_PointCenter          {cv_Name BB_Position type active} {
                #
            variable    stageScale
                #
            variable    Rendering
    ...
    proc rattleCAD::cv_custom::createDimension_PointPersonal          {cv_Name BB_Position type active} {
                #
            variable    stageScale
                #
            variable    Rendering
    ...
    proc rattleCAD::cv_custom::createDimension_PointCrank          {cv_Name BB_Position type active} {
                #
            variable    stageScale
                #
            variable    Rendering
    ...
    proc rattleCAD::cv_custom::createDimension_PointReference          {cv_Name BB_Position type active} {
                # point_reference 
                #
            variable    stageScale
                #
    ...
    proc rattleCAD::cv_custom::createDimension_PointSeat          {cv_Name BB_Position type active} {
                # point_seat 
                #
            variable    stageScale
                #
    ...
    proc rattleCAD::cv_custom::createDimension_PointFrame         {cv_Name BB_Position type active} {
                # point_frame
                #
            variable    stageScale
                #
    ...
    proc rattleCAD::cv_custom::createDimension_PointFrameDimension          {cv_Name BB_Position type active} {
    ...
    proc rattleCAD::cv_custom::createDimension_CLineFrame          {cv_Name BB_Position type active} {
                # cline_frame 
                #
            variable    stageScale
                #
    ...
    proc rattleCAD::cv_custom::createDimension_CLineAngle          {cv_Name BB_Position type active} {
                # cline_angle 
                #
            variable    stageScale
                #
    ...
    proc rattleCAD::cv_custom::createDimension_CLineBrake          {cv_Name BB_Position type active} {
                # cline_brake 
                #
            variable    stageScale
                #
    ...
    proc rattleCAD::cv_custom::createDimension_CLineFramJig          {cv_Name BB_Position type active} {
                # cline_framejig
                #
            variable    stageScale
                #
    ...
    proc rattleCAD::cv_custom::createDimension_Geometry_BG          {cv_Name BB_Position type active} {
                # geometry_bg
                #
            variable    stageScale
                #
    ...
    proc rattleCAD::cv_custom::createDimension_Any                  {cv_Name BB_Position type active} {
