...
#[format {rattleCAD::view::gui::notebook_ButtonEvent %s %s} $cv $cv_ButtonContent ]    
    ...
    proc rattleCAD::view::edit::single_Result_Saddle_Offset_HB_X        {x y cv_Name}   { rattleCAD::view::createEdit  $x $y $cv_Name   Scalar(Geometry/Saddle_HB_x)            }   ;# Result(Length/Saddle/Offset_HB)           
    proc rattleCAD::view::edit::single_Result_Saddle_Offset_HB_Y        {x y cv_Name}   { rattleCAD::view::createEdit  $x $y $cv_Name   Scalar(Geometry/Saddle_HB_y)            }   ;# Result(Length/Saddle/Offset_HB)           
    ...
    proc rattleCAD::view::edit::single_CrankSet_ChainRingOffset         {x y cv_Name}   { rattleCAD::view::createEdit  $x $y $cv_Name   Scalar(CrankSet/ChainRingOffset)        }   ;# Component(CrankSet/ChainRingOffset)                 
    ...
    proc rattleCAD::view::edit::single_RearHub_DiscDiameter             {x y cv_Name}   { rattleCAD::view::createEdit  $x $y $cv_Name   Scalar(RearMockup/DiscDiameter)         }   ;# Rendering(RearMockup/DiscDiameter)              
