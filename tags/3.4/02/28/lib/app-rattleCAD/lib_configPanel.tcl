 ...
 namespace eval rattleCAD::configPanel {
    ...
    proc rattleCAD::configPanel::init_configValues {} {
                #
            variable _currentValue
            variable _updateValue
                #
    ...
    #-------------------------------------------------------------------------
       #  add content 01
       #
    proc rattleCAD::configPanel::add_Basic {w} {
    ...
    #-------------------------------------------------------------------------
       #  add content 02
       #
    proc rattleCAD::configPanel::add_FrameDetails {w} {
    ...
    #-------------------------------------------------------------------------
       #  add content 03
       #
    proc rattleCAD::configPanel::add_FrameCheck {w} {
    ...
    #-------------------------------------------------------------------------
       #  add content 04
       #
    proc rattleCAD::configPanel::add_BikeComponents {w} {
    ...
    #-------------------------------------------------------------------------
       #  ListboxEvent Event
       #
    proc rattleCAD::configPanel::ListboxEvent {w targetCanvas targetVar mode} {
                #
    ...
    #-------------------------------------------------------------------------
       #  create config_line
       #
    proc rattleCAD::configPanel::updateCanvas {targetCanvas} {
            variable compCanvas
            variable frameCanvas
            variable compFile
    ...
    #-------------------------------------------------------------------------
       ...
       #
    proc rattleCAD::configPanel::change_ValueEdit {textVar scale direction} {
    ...
    #-------------------------------------------------------------------------
       #  create config_line
       #
    proc rattleCAD::configPanel::create_config_cBox {w _arrayName contentList} {
    ...
    #-------------------------------------------------------------------------
       #  create config_line
       #
    proc rattleCAD::configPanel::create_configEdit_title {w title _arrayName scale {color {}}} {
    ...
    #-------------------------------------------------------------------------
       #  create config_line
       #
    proc rattleCAD::configPanel::create_configEdit {w _arrayName scale {color {}}} {
    ...
    proc rattleCAD::configPanel::bind_MouseWheel {entry scale value} {
    ...
    proc rattleCAD::configPanel::bind_selectEntry {entry} {
            # puts "   ... selectEntry"
            return
    }
    proc rattleCAD::configPanel::bind_enterEntry {entry} {
    ...
    proc rattleCAD::configPanel::bind_leaveEntry {entry} {
                #
	...
	proc rattleCAD::configPanel::bind_notebookTabChanged {notebook} {
        puts "   -> $notebook"
    ...
    proc rattleCAD::configPanel::tubing_checkAngles {} {
    ...
    proc rattleCAD::configPanel::check_Value { w xPath} {
                #
            set oldValue {}
                #
