 ...
 namespace eval rattleCAD::configPanel {
    ...
    proc init_configValues_21 {} {
                #
            tk_messageBox -message "init_configValues_21"    
                #
            # set projectDict [rattleCAD::model::get_projectDICT]
                #
            # appUtil::pdict $projectDict
                #
            update
                #
			if {1 == 2} {
    ...
    proc init_configValues_OLD {} {
            ...
            set ::rattleCAD::configPanel::Component(Fork/Crown/File)                      [ rattleCAD::model::get_Component   ForkCrown                         ]
            set ::rattleCAD::configPanel::Component(Fork/DropOut/File)                    [ rattleCAD::model::get_Component   ForkDropout                       ]
            ...
            set ::rattleCAD::configPanel::Component(Stem/Angle)                           [ rattleCAD::model::get_Scalar      Geometry      Stem_Angle          ]
            set ::rattleCAD::configPanel::Component(Stem/Length)                          [ rattleCAD::model::get_Scalar      Geometry      Stem_Length         ]
            ...
            set ::rattleCAD::configPanel::Custom(BottomBracket/Depth)                     [ rattleCAD::model::get_Scalar      Geometry      BottomBracket_Depth ]
            ...
            set ::rattleCAD::configPanel::Custom(WheelPosition/Rear)                      [ rattleCAD::model::get_Scalar      Geometry      ChainStay_Length ]
            ...
            set ::rattleCAD::configPanel::Lugs(RearDropOut/File)                          [ rattleCAD::model::get_Component   RearDropout                       ]
            ...
            set ::rattleCAD::configPanel::Result(Length/BottomBracket/Height)             [ rattleCAD::model::get_Scalar      Geometry      BottomBracket_Height]
            ...
            set ::rattleCAD::configPanel::Result(Length/TopTube/VirtualLength)            z[ rattleCAD::model::get_Scalar      Geometry      TopTubeVirtual      ]
                #
            update
                #
			if {1 == 2} {
    ...
    proc add_FrameDetails {w} {
            ...
            ttk::labelframe    $menueFrame.sf.lf_09        -text "Frame & Fork Parts"
                ...
                set compList {  Config/Fork
                                Component/RearDropout
                                Component/ForkCrown
    ...
    proc add_BikeComponents {w} {
            ...
            ttk::labelframe    $menueFrame.sf.lf_01        -text "Components"
                ...
                foreach xPath $compList {
						...
						ttk::combobox $fileFrame.cb -textvariable $textvariable \
                            ...
                            bind $fileFrame.cb <<ComboboxSelected>> [list [namespace current]::::ListboxEvent %W cv_Components [format "%s::%s(%s)" [namespace current] _updateValue $xPath] select]
                            bind $fileFrame.cb <ButtonPress>        [list [namespace current]::::ListboxEvent %W cv_Components [format "%s::%s(%s)" [namespace current] _updateValue $xPath] update]
                }
            ...
            ttk::labelframe $menueFrame.sf.lf_02        -text "Options"
                ...
                # -----------------
                #   Rendering
                set entryList { {Fork Type}         Config/Fork                      Fork  \
                                {Fork Blade Type}   Config/ForkBlade                 ForkBlade  \
                                {Brake Type Front}  Config/FrontBrake                Brake \
                                {Brake Type Rear}   Config/RearBrake                 Brake \
                                {BottleCage ST}     Config/BottleCage_SeatTube       BottleCage \
                                {BottleCage DT}     Config/BottleCage_DownTube       BottleCage \
                                {BottleCage DT L}   Config/BottleCage_DownTube_Lower BottleCage \
                                {Fender Front}      Config/FrontFender               Binary_OnOff  \
                                {Fender Rear}       Config/RearFender                Binary_OnOff  \
                            }
                    set i 10
                foreach {label xPath listName} $entryList {
