 ...
 #
    ...
    proc rattleCAD::cv_custom::createDimension_Geometry_FG          {cv_Name BB_Position type active} {
            ...
            if {$active == {on}} {
                    ...
                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_HT_Length     group_HeadTubeParameter_01
                    proc ::rattleCAD::view::edit::group_HeadTubeParameter_01        {x y cv_Name} {  
                            rattleCAD::view::createEdit  $x $y $cv_Name  { \
                                    FrameTubes(HeadTube/Length) \
                                    Component(HeadSet/Height/Bottom) \
                                }   {new - Head Tube Parameter}
                    }                    
                    ...
                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_SN_Position_x     group_SaddleParameter_01
                    proc ::rattleCAD::view::edit::group_SaddleParameter_01        {x y cv_Name} {  
                            rattleCAD::view::createEdit  $x $y $cv_Name  { \
                                    Result(Length/Saddle/Offset_BB_Nose) \
                                    Component(Saddle/LengthNose) \
                                    Rendering(Saddle/Offset_X) \
                                }   {new - Saddle Parameter}
                    }
                    ...
                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_FW_Radius     group_FrontWheelParameter_01
                    proc ::rattleCAD::view::edit::group_FrontWheelParameter_01        {x y cv_Name} {  
                            rattleCAD::view::createEdit  $x $y $cv_Name  { \
                                    list://Component(Wheel/Front/RimDiameter@SELECT_Rim) \
                                    Component(Wheel/Front/TyreHeight) \
                                } {new - Front Wheel Parameter}
                    }
                    ...
                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_ST_Length         single_Result_SaddleOffset_BB_ST
                    ...
                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_SD_HB_Height       single_Result_SaddleOffset_HB
                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_SD_ST_Length       single_Result_SaddleSeatTube_BB
    ...
    proc rattleCAD::cv_custom::createDimension_Summary_FG           {cv_Name BB_Position type active} {
            ...
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_SD_Nose_Dist       single_Result_SaddleOffset_BB_Nose
    ...
    proc rattleCAD::cv_custom::createDimension_Reference_FG         {cv_Name BB_Position type} {
            ...
            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_FW_Radius      group_FrontWheelParameter_02
            proc ::rattleCAD::view::edit::group_FrontWheelParameter_02       {x y cv_Name} {  
                    rattleCAD::view::createEdit  $x $y $cv_Name  { \
                            list://Component(Wheel/Front/RimDiameter@SELECT_Rim) \
    ...
    proc rattleCAD::cv_custom::createDimension_TopHeadTubeAngle     {cv_Name BB_Position type updateCommand} {
            ...
            set dimension       [ $cv_Name dimension  angle     [ appUtil::flatten_nestedList [list $TopTube(Steerer) $Steerer(Stem) $TopTube(SeatTube)] ] \
                                                                    ...
                                                                    darkblue ]
            if {$updateCommand != {}} { 
                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $dimension      single_Result_HeadTubeTopTubeAngle
            }
    }
