 ...
 namespace eval rattleCAD::view::edit {
        ...
        # -- Rendering - Options --------------------------
        #
    proc rattleCAD::view::edit::option_ForkType                         {x y cv_Name}   { rattleCAD::view::createEdit  $x $y $cv_Name   list://Config(Fork@SELECT_ForkType)                          }
    ...
    proc rattleCAD::view::edit::single_Result_RearWheelTyreShoulder     {x y cv_Name}   { rattleCAD::view::createEdit  $x $y $cv_Name   Scalar(RearWheel/TyreShoulder))         ;# Result(Length/RearWheel/TyreShoulder)         }
        ...
        # set _lastValue(Result/Angle/HeadTube/TopTube)                                   dict set returnDict            Scalar  Result      Angle_HeadTubeTopTube   
        # set _lastValue(Result/Angle/SeatTube/Direction)                                 dict set returnDict            Scalar  SeatTube    Angle                   
        # set _lastValue(Result/Length/BottomBracket/Height)                              dict set returnDict            Scalar  Geometry BottomBracket_Height       
        # set _lastValue(Result/Length/FrontWheel/Radius)                                 dict set returnDict            Scalar  Geometry FrontWheel_Radius          
        # set _lastValue(Result/Length/FrontWheel/diagonal)                               dict set returnDict            Scalar  Geometry FrontWheel_xy              
        # set _lastValue(Result/Length/FrontWheel/horizontal)                             dict set returnDict            Scalar  Geometry FrontWheel_x               
        # set _lastValue(Result/Length/HeadTube/ReachLength)                              dict set returnDict            Scalar  Geometry ReachLengthResult          
        # set _lastValue(Result/Length/HeadTube/StackHeight)                              dict set returnDict            Scalar  Geometry StackHeightResult          
        # set _lastValue(Result/Length/Personal/SaddleNose_HB)                            dict set returnDict            Scalar  Geometry SaddleNose_HB              
        # set _lastValue(Result/Length/RearWheel/Radius)                                  dict set returnDict            Scalar  Geometry RearWheel_Radius           
        # set _lastValue(Result/Length/RearWheel/TyreShoulder)                            dict set returnDict            Scalar  RearWheel   TyreShoulder            
        # set _lastValue(Result/Length/RearWheel/horizontal)                              dict set returnDict            Scalar  Geometry RearWheel_x                
        # set _lastValue(Result/Length/Reference/Heigth_SN_HB)                            dict set returnDict            Scalar  Reference   SaddleNose_HB_y         
        # set _lastValue(Result/Length/Reference/SaddleNose_HB)                           dict set returnDict            Scalar  Reference   SaddleNose_HB           
        # set _lastValue(Result/Length/Saddle/Offset_BB_Nose)                             dict set returnDict            Scalar  Geometry SaddleNose_BB_x            
        # set _lastValue(Result/Length/Saddle/Offset_BB_ST)                               dict set returnDict            Scalar  Geometry Saddle_Offset_BB_ST        
        # set _lastValue(Result/Length/Saddle/Offset_HB)                                  dict set returnDict            Scalar  Geometry Saddle_HB_y                
        # set _lastValue(Result/Length/Saddle/SeatTube_BB)                                dict set returnDict            Scalar  Geometry Saddle_BB                  
        # set _lastValue(Result/Length/SeatTube/VirtualLength)                            dict set returnDict            Scalar  Geometry SeatTubeVirtual            
        # set _lastValue(Result/Length/TopTube/VirtualLength)                             dict set returnDict            Scalar  Geometry TopTubeVirtual                 
        #
# proc rattleCAD::view::edit::single_Result_BottomBracket_Height      {x y cv_Name}   { rattleCAD::view::createEdit  $x $y $cv_Name   Result(Length/BottomBracket/Height)       }
        ...
        # proc rattleCAD::view::edit::single_Result_HeadTube_TopTubeAngle     {x y cv_Name}   { rattleCAD::view::createEdit  $x $y $cv_Name   Scalar(Result/Angle_HeadTubeTopTube)      }
    ...
    proc rattleCAD::view::edit::single_ChainStay_ProfileWidth_03        {x y cv_Name}   { rattleCAD::view::createEdit  $x $y $cv_Name   FrameTubes(ChainStay/WidthBB)                 }
    ...
    proc rattleCAD::view::edit::single_RearWheel_Distance               {x y cv_Name}   { rattleCAD::view::createEdit  $x $y $cv_Name   Scalar(Geometry/ChainStay_Length)             }
