...
namespace eval rattleCAD::model {
    ...
    proc rattleCAD::model::__getObject_expired {object index {centerPoint {0 0}} } {
        return [bikeGeometry::get_Object $object $index $centerPoint]
    }

    proc rattleCAD::model::getComponentDir___unused {} {
        return [bikeGeometry::get_ComponentDir]
    }

    proc rattleCAD::model::getComponentDirectories___unused {} {
        return [bikeGeometry::get_ComponentDirectories]
    }

    proc rattleCAD::model::coords_get_xy___unused {coordlist index} {
