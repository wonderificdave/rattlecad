  ...
  #-------------------------------------------------------------------------
       #  Debug 
       #
  proc AppUtil::Debug { mode args } {
        # debug_out "        DEBUG 0: Debug '$mode' '$var' '$args'\n"
      ...
      if {$return_dbg_level>$DebugLevel} return
           ...
           # debug_out     "        init Debug:   return_proclevel  $return_proclevel \n" 
           # debug_out     "        init Debug:   lvl  $lvl \n" 
           # debug_out     "        init Debug:   return_dbg_level  $return_dbg_level \n" 
           # debug_out     "        init Debug:   DebugLevel  $DebugLevel \n" 
