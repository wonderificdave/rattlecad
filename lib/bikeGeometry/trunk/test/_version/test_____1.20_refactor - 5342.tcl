...
namespace eval rattleCAD {
    ...
    proc compareValues {procName argList {value_2 {}}} {
        variable failedQueries
        switch -exact [llength $argList] {
            1   {   set value_1 [bikeGeometry::$procName $argList]
                    set keyString "$procName@$argList"
                }
            2   {   set key_1 [lindex $argList 0]
                    set key_2 [lindex $argList 1]
                    set value_1 [bikeGeometry::$procName $key_1 $key_2 ]
                    set keyString "$procName@$key_1/$key_2"
                }
            3   {   set key_1 [lindex $argList 0]
                    set key_2 [lindex $argList 1]
                    set key_3 [lindex $argList 2]
                    set value_1 [bikeGeometry::$procName $key_1 $key_2 $key_3 ]
                    set keyString "$procName@$key_1/$key_2/$key_3"
               }
        }
        
        puts     "   check ....  <1> ... $value_1"
        if {$value_1 == $value_2} {
            puts "               <2> ... $value_2"
        } else {
            puts "   ... failed  <2> ... $procName $argList"
            puts "               <2> ... $value_2"
            set failedQueries($keyString) [list $value_1]
            #exit
        }
    }
    #
...
set RearHub_Position    {600 50}
    #
        ...
        #
    puts " ... [bikeGeometry::get_Component        CrankSet                          ]"               ;# set _lastValue(Component/CrankSet/File)                                 
    puts " ... [bikeGeometry::get_Component        Fork CrownFile                    ]"               ;# set _lastValue(Component/Fork/Crown/File)                               
    puts " ... [bikeGeometry::get_Component        Fork DropOutFile                  ]"               ;# set _lastValue(Component/Fork/DropOut/File)                             
    puts " ... [bikeGeometry::get_Component        FrontBrake                        ]"               ;# set _lastValue(Component/Brake/Front/File)                              
    puts " ... [bikeGeometry::get_Component        FrontCarrier                      ]"               ;# set _lastValue(Component/Carrier/Front/File)                            
    puts " ... [bikeGeometry::get_Component        FrontDerailleur                   ]"               ;# set _lastValue(Component/Derailleur/Front/File)                         
    puts " ... [bikeGeometry::get_Component        HandleBar                         ]"               ;# set _lastValue(Component/HandleBar/File)                                
    puts " ... [bikeGeometry::get_Component        Logo                              ]"               ;# set _lastValue(Component/Logo/File)                                     
    puts " ... [bikeGeometry::get_Component        RearBrake                         ]"               ;# set _lastValue(Component/Brake/Rear/File)                               
    puts " ... [bikeGeometry::get_Component        RearCarrier                       ]"               ;# set _lastValue(Component/Carrier/Rear/File)                             
    puts " ... [bikeGeometry::get_Component        RearDerailleur                    ]"               ;# set _lastValue(Component/Derailleur/Rear/File)                          
    puts " ... [bikeGeometry::get_Component        RearDropout File                  ]"               ;# set _lastValue(Lugs/RearDropOut/File)                                   
    puts " ... [bikeGeometry::get_Component        Saddle                            ]"               ;# set _lastValue(Component/Saddle/File)                                   
    puts " ... [bikeGeometry::get_Config           BottleCage_DT                     ]"               ;# set _lastValue(Rendering/BottleCage/DownTube)                           
    puts " ... [bikeGeometry::get_Config           BottleCage_DT_L                   ]"               ;# set _lastValue(Rendering/BottleCage/DownTube_Lower)                     
    puts " ... [bikeGeometry::get_Config           BottleCage_ST                     ]"               ;# set _lastValue(Rendering/BottleCage/SeatTube)                           
    puts " ... [bikeGeometry::get_Config           ChainStay                         ]"               ;# set _lastValue(Rendering/ChainStay)                                     
    puts " ... [bikeGeometry::get_Config           Fork                              ]"               ;# set _lastValue(Rendering/Fork)                                          
    puts " ... [bikeGeometry::get_Config           ForkBlade                         ]"               ;# set _lastValue(Rendering/ForkBlade)                                     
    puts " ... [bikeGeometry::get_Config           ForkDropout                       ]"               ;# set _lastValue(Rendering/ForkDropOut)                                   
    puts " ... [bikeGeometry::get_Config           FrontBrake                        ]"               ;# set _lastValue(Rendering/Brake/Front)                                   
    puts " ... [bikeGeometry::get_Config           FrontFender                       ]"               ;# set _lastValue(Rendering/Fender/Front)                                  
    puts " ... [bikeGeometry::get_Config           RearBrake                         ]"               ;# set _lastValue(Rendering/Brake/Rear)                                    
    puts " ... [bikeGeometry::get_Config           RearDropout                       ]"               ;# set _lastValue(Rendering/RearDropOut)                                   
    puts " ... [bikeGeometry::get_Config           RearDropoutOrient                 ]"               ;# set _lastValue(Lugs/RearDropOut/Direction)                              
    puts " ... [bikeGeometry::get_Config           RearFender                        ]"               ;# set _lastValue(Rendering/Fender/Rear)                                   
    puts " ...                                                                        "
    puts " ... [bikeGeometry::get_Scalar           CrankSet ChainRings               ]"               ;# set _lastValue(Component/CrankSet/ChainRings)                           
    puts " ...                                                                        "
    puts " ... [bikeGeometry::get_Scalar           BottleCage DownTube               ]"               ;# set _lastValue(Component/BottleCage/DownTube/OffsetBB)                  
    puts " ... [bikeGeometry::get_Scalar           BottleCage DownTube_Lower         ]"               ;# set _lastValue(Component/BottleCage/DownTube_Lower/OffsetBB)            
    puts " ... [bikeGeometry::get_Scalar           BottleCage SeatTube               ]"               ;# set _lastValue(Component/BottleCage/SeatTube/OffsetBB)                  
    puts " ... [bikeGeometry::get_Scalar           BottomBracket InsideDiameter      ]"               ;# set _lastValue(Lugs/BottomBracket/Diameter/inside)                      
    puts " ... [bikeGeometry::get_Scalar           BottomBracket OffsetCS_TopView    ]"               ;# set _lastValue(Lugs/BottomBracket/ChainStay/Offset_TopView)             
    puts " ... [bikeGeometry::get_Scalar           BottomBracket OutsideDiameter     ]"               ;# set _lastValue(Lugs/BottomBracket/Diameter/outside)                     
    puts " ... [bikeGeometry::get_Scalar           BottomBracket Width               ]"               ;# set _lastValue(Lugs/BottomBracket/Width)                                
    puts " ... [bikeGeometry::get_Scalar           ChainStay DiameterSS              ]"               ;# set _lastValue(FrameTubes/ChainStay/DiameterSS)                         
    puts " ... [bikeGeometry::get_Scalar           ChainStay Height                  ]"               ;# set _lastValue(FrameTubes/ChainStay/Height)                             
    puts " ... [bikeGeometry::get_Scalar           ChainStay HeigthBB                ]"               ;# set _lastValue(FrameTubes/ChainStay/HeightBB)                           
    puts " ... [bikeGeometry::get_Scalar           ChainStay TaperLength             ]"               ;# set _lastValue(FrameTubes/ChainStay/TaperLength)                        
    puts " ... [bikeGeometry::get_Scalar           ChainStay completeLength          ]"               ;# set _lastValue(FrameTubes/ChainStay/Profile/completeLength)             
    puts " ... [bikeGeometry::get_Scalar           ChainStay cuttingLeft             ]"               ;# set _lastValue(FrameTubes/ChainStay/Profile/cuttingLeft)                
    puts " ... [bikeGeometry::get_Scalar           ChainStay cuttingLength           ]"               ;# set _lastValue(FrameTubes/ChainStay/Profile/cuttingLength)              
    puts " ... [bikeGeometry::get_Scalar           ChainStay profile_x01             ]"               ;# set _lastValue(FrameTubes/ChainStay/Profile/length_01)                  
    puts " ... [bikeGeometry::get_Scalar           ChainStay profile_x02             ]"               ;# set _lastValue(FrameTubes/ChainStay/Profile/length_02)                  
    puts " ... [bikeGeometry::get_Scalar           ChainStay profile_x03             ]"               ;# set _lastValue(FrameTubes/ChainStay/Profile/length_03)                  
    puts " ... [bikeGeometry::get_Scalar           ChainStay profile_y00             ]"               ;# set _lastValue(FrameTubes/ChainStay/Profile/width_00)                   
    puts " ... [bikeGeometry::get_Scalar           ChainStay profile_y01             ]"               ;# set _lastValue(FrameTubes/ChainStay/Profile/width_01)                   
    puts " ... [bikeGeometry::get_Scalar           ChainStay profile_y02             ]"               ;# set _lastValue(FrameTubes/ChainStay/Profile/width_02)                   
    puts " ... [bikeGeometry::get_Scalar           ChainStay profile_y03             ]"               ;# set _lastValue(FrameTubes/ChainStay/Profile/width_03)                   
    puts " ... [bikeGeometry::get_Scalar           ChainStay segmentAngle_01         ]"               ;# set _lastValue(FrameTubes/ChainStay/CenterLine/angle_01)                
    puts " ... [bikeGeometry::get_Scalar           ChainStay segmentAngle_02         ]"               ;# set _lastValue(FrameTubes/ChainStay/CenterLine/angle_02)                
    puts " ... [bikeGeometry::get_Scalar           ChainStay segmentAngle_03         ]"               ;# set _lastValue(FrameTubes/ChainStay/CenterLine/angle_03)                
    puts " ... [bikeGeometry::get_Scalar           ChainStay segmentAngle_04         ]"               ;# set _lastValue(FrameTubes/ChainStay/CenterLine/angle_04)                
    puts " ... [bikeGeometry::get_Scalar           ChainStay segmentLength_01        ]"               ;# set _lastValue(FrameTubes/ChainStay/CenterLine/length_01)               
    puts " ... [bikeGeometry::get_Scalar           ChainStay segmentLength_02        ]"               ;# set _lastValue(FrameTubes/ChainStay/CenterLine/length_02)               
    puts " ... [bikeGeometry::get_Scalar           ChainStay segmentLength_03        ]"               ;# set _lastValue(FrameTubes/ChainStay/CenterLine/length_03)               
    puts " ... [bikeGeometry::get_Scalar           ChainStay segmentLength_04        ]"               ;# set _lastValue(FrameTubes/ChainStay/CenterLine/length_04)               
    puts " ... [bikeGeometry::get_Scalar           ChainStay segmentRadius_01        ]"               ;# set _lastValue(FrameTubes/ChainStay/CenterLine/radius_01)               
    puts " ... [bikeGeometry::get_Scalar           ChainStay segmentRadius_02        ]"               ;# set _lastValue(FrameTubes/ChainStay/CenterLine/radius_02)               
    puts " ... [bikeGeometry::get_Scalar           ChainStay segmentRadius_03        ]"               ;# set _lastValue(FrameTubes/ChainStay/CenterLine/radius_03)               
    puts " ... [bikeGeometry::get_Scalar           ChainStay segmentRadius_04        ]"               ;# set _lastValue(FrameTubes/ChainStay/CenterLine/radius_04)               
    puts " ... [bikeGeometry::get_Scalar           CrankSet ArmWidth                 ]"               ;# set _lastValue(Component/CrankSet/ArmWidth)                             
    puts " ... [bikeGeometry::get_Scalar           CrankSet ChainLine                ]"               ;# set _lastValue(Component/CrankSet/ChainLine)                            
    puts " ... [bikeGeometry::get_Scalar           CrankSet Length                   ]"               ;# set _lastValue(Component/CrankSet/Length)                               
    puts " ... [bikeGeometry::get_Scalar           CrankSet PedalEye                 ]"               ;# set _lastValue(Component/CrankSet/PedalEye)                             
    puts " ... [bikeGeometry::get_Scalar           CrankSet Q-Factor                 ]"               ;# set _lastValue(Component/CrankSet/Q-Factor)                             
    puts " ... [bikeGeometry::get_Scalar           DownTube DiameterBB               ]"               ;# set _lastValue(FrameTubes/DownTube/DiameterBB)                          
    puts " ... [bikeGeometry::get_Scalar           DownTube DiameterHT               ]"               ;# set _lastValue(FrameTubes/DownTube/DiameterHT)                          
    puts " ... [bikeGeometry::get_Scalar           DownTube OffsetBB                 ]"               ;# set _lastValue(Custom/DownTube/OffsetBB)                                
    puts " ... [bikeGeometry::get_Scalar           DownTube OffsetHT                 ]"               ;# set _lastValue(Custom/DownTube/OffsetHT)                                
    puts " ... [bikeGeometry::get_Scalar           DownTube TaperLength              ]"               ;# set _lastValue(FrameTubes/DownTube/TaperLength)                         
    puts " ... [bikeGeometry::get_Scalar           Fork BladeBendRadius              ]"               ;# set _lastValue(Component/Fork/Blade/BendRadius)                         
    puts " ... [bikeGeometry::get_Scalar           Fork BladeDiameterDO              ]"               ;# set _lastValue(Component/Fork/Blade/DiameterDO)                         
    puts " ... [bikeGeometry::get_Scalar           Fork BladeEndLength               ]"               ;# set _lastValue(Component/Fork/Blade/EndLength)                          
    puts " ... [bikeGeometry::get_Scalar           Fork BladeOffsetCrown             ]"               ;# set _lastValue(Component/Fork/Crown/Blade/Offset)                       
    puts " ... [bikeGeometry::get_Scalar           Fork BladeOffsetCrownPerp         ]"               ;# set _lastValue(Component/Fork/Crown/Blade/OffsetPerp)                   
    puts " ... [bikeGeometry::get_Scalar           Fork BladeOffsetDO                ]"               ;# set _lastValue(Component/Fork/DropOut/Offset)                           
    puts " ... [bikeGeometry::get_Scalar           Fork BladeOffsetDOPerp            ]"               ;# set _lastValue(Component/Fork/DropOut/OffsetPerp)                       
    puts " ... [bikeGeometry::get_Scalar           Fork BladeTaperLength             ]"               ;# set _lastValue(Component/Fork/Blade/TaperLength)                        
    puts " ... [bikeGeometry::get_Scalar           Fork BladeWidth                   ]"               ;# set _lastValue(Component/Fork/Blade/Width)                              
    puts " ... [bikeGeometry::get_Scalar           Fork BrakeAngle                   ]"               ;# set _lastValue(Component/Fork/Crown/Brake/Angle)                        
    puts " ... [bikeGeometry::get_Scalar           Fork BrakeOffset                  ]"               ;# set _lastValue(Component/Fork/Crown/Brake/Offset)                       
    puts " ... [bikeGeometry::get_Scalar           Fork Height                       ]"               ;# set _lastValue(Component/Fork/Height)                                   
    puts " ... [bikeGeometry::get_Scalar           Fork Rake                         ]"               ;# set _lastValue(Component/Fork/Rake)                                     
    puts " ... [bikeGeometry::get_Scalar           FrontBrake LeverLength            ]"               ;# set _lastValue(Component/Brake/Front/LeverLength)                       
    puts " ... [bikeGeometry::get_Scalar           FrontBrake Offset                 ]"               ;# set _lastValue(Component/Brake/Front/Offset)                            
    puts " ... [bikeGeometry::get_Scalar           FrontCarrier x                    ]"               ;# set _lastValue(Component/Carrier/Front/x)                               
    puts " ... [bikeGeometry::get_Scalar           FrontCarrier y                    ]"               ;# set _lastValue(Component/Carrier/Front/y)                               
    puts " ... [bikeGeometry::get_Scalar           FrontDerailleur Distance          ]"               ;# set _lastValue(Component/Derailleur/Front/Distance)                     
    puts " ... [bikeGeometry::get_Scalar           FrontDerailleur Offset            ]"               ;# set _lastValue(Component/Derailleur/Front/Offset)                       
    puts " ... [bikeGeometry::get_Scalar           FrontFender Height                ]"               ;# set _lastValue(Component/Fender/Front/Height)                           
    puts " ... [bikeGeometry::get_Scalar           FrontFender OffsetAngle           ]"               ;# set _lastValue(Component/Fender/Front/OffsetAngle)                      
    puts " ... [bikeGeometry::get_Scalar           FrontFender OffsetAngleFront      ]"               ;# set _lastValue(Component/Fender/Front/OffsetAngleFront)                 
    puts " ... [bikeGeometry::get_Scalar           FrontFender Radius                ]"               ;# set _lastValue(Component/Fender/Front/Radius)                           
    puts " ... [bikeGeometry::get_Scalar           FrontWheel RimDiameter            ]"               ;# set _lastValue(Component/Wheel/Front/RimDiameter)                       
    puts " ... [bikeGeometry::get_Scalar           FrontWheel RimHeight              ]"               ;# set _lastValue(Component/Wheel/Front/RimHeight)                         
    puts " ... [bikeGeometry::get_Scalar           FrontWheel TyreHeight             ]"               ;# set _lastValue(Component/Wheel/Front/TyreHeight)                        
    puts " ... [bikeGeometry::get_Scalar           Geometry BottomBracket_Depth      ]"               ;# set _lastValue(Custom/BottomBracket/Depth)                              
    puts " ... [bikeGeometry::get_Scalar           Geometry BottomBracket_Height     ]"               ;# set _lastValue(Result/Length/BottomBracket/Height)                      
    puts " ... [bikeGeometry::get_Scalar           Geometry ChainStay_Length         ]"               ;# set _lastValue(Custom/WheelPosition/Rear)                               
    puts " ... [bikeGeometry::get_Scalar           Geometry FrontWheel_Radius        ]"               ;# set _lastValue(Result/Length/FrontWheel/Radius)                         
    puts " ... [bikeGeometry::get_Scalar           Geometry FrontWheel_x             ]"               ;# set _lastValue(Result/Length/FrontWheel/horizontal)                     
    puts " ... [bikeGeometry::get_Scalar           Geometry FrontWheel_xy            ]"               ;# set _lastValue(Result/Length/FrontWheel/diagonal)                       
    puts " ... [bikeGeometry::get_Scalar           Geometry HandleBar_Distance       ]"               ;# set _lastValue(Personal/HandleBar_Distance)                             
    puts " ... [bikeGeometry::get_Scalar           Geometry HandleBar_Height         ]"               ;# set _lastValue(Personal/HandleBar_Height)                               
    puts " ... [bikeGeometry::get_Scalar           Geometry HeadTube_Angle           ]"               ;# set _lastValue(Custom/HeadTube/Angle)                                   
    puts " ... [bikeGeometry::get_Scalar           Geometry Inseam_Length            ]"               ;# set _lastValue(Personal/InnerLeg_Length)                                
    puts " ... [bikeGeometry::get_Scalar           Geometry ReachLengthResult        ]"               ;# set _lastValue(Result/Length/HeadTube/ReachLength)                      
    puts " ... [bikeGeometry::get_Scalar           Geometry RearWheel_Radius         ]"               ;# set _lastValue(Result/Length/RearWheel/Radius)                          
    puts " ... [bikeGeometry::get_Scalar           Geometry RearWheel_x              ]"               ;# set _lastValue(Result/Length/RearWheel/horizontal)                      
    puts " ... [bikeGeometry::get_Scalar           Geometry SaddleNose_BB_x          ]"               ;# set _lastValue(Result/Length/Saddle/Offset_BB_Nose)                     
    puts " ... [bikeGeometry::get_Scalar           Geometry SaddleNose_HB            ]"               ;# set _lastValue(Result/Length/Personal/SaddleNose_HB)                    
    puts " ... [bikeGeometry::get_Scalar           Geometry Saddle_BB                ]"               ;# set _lastValue(Result/Length/Saddle/SeatTube_BB)                        
    puts " ... [bikeGeometry::get_Scalar           Geometry Saddle_Distance          ]"               ;# set _lastValue(Personal/Saddle_Distance)                                
    puts " ... [bikeGeometry::get_Scalar           Geometry Saddle_HB_y              ]"               ;# set _lastValue(Result/Length/Saddle/Offset_HB)                          
    puts " ... [bikeGeometry::get_Scalar           Geometry Saddle_Offset_BB_ST      ]"               ;# set _lastValue(Result/Length/Saddle/Offset_BB_ST)                       
    puts " ... [bikeGeometry::get_Scalar           Geometry SeatTubeVirtual          ]"               ;# set _lastValue(Result/Length/SeatTube/VirtualLength)                    
    puts " ... [bikeGeometry::get_Scalar           Geometry StackHeightResult        ]"               ;# set _lastValue(Result/Length/HeadTube/StackHeight)                      
    puts " ... [bikeGeometry::get_Scalar           Geometry Stem_Angle               ]"               ;# set _lastValue(Component/Stem/Angle)                                    
    puts " ... [bikeGeometry::get_Scalar           Geometry Stem_Length              ]"               ;# set _lastValue(Component/Stem/Length)                                   
    puts " ... [bikeGeometry::get_Scalar           Geometry TopTubeVirtual           ]"               ;# set _lastValue(Result/Length/TopTube/VirtualLength)                     
    puts " ... [bikeGeometry::get_Scalar           Geometry TopTube_Angle            ]"               ;# set _lastValue(Custom/TopTube/Angle)                                    
    puts " ... [bikeGeometry::get_Scalar           HandleBar PivotAngle              ]"               ;# set _lastValue(Component/HandleBar/PivotAngle)                          
    puts " ... [bikeGeometry::get_Scalar           HeadSet Diameter                  ]"               ;# set _lastValue(Component/HeadSet/Diameter)                              
    puts " ... [bikeGeometry::get_Scalar           HeadSet Height_Bottom             ]"               ;# set _lastValue(Component/HeadSet/Height/Bottom)                         
    puts " ... [bikeGeometry::get_Scalar           HeadSet Height_Top                ]"               ;# set _lastValue(Component/HeadSet/Height/Top)                            
    puts " ... [bikeGeometry::get_Scalar           HeadTube Diameter                 ]"               ;# set _lastValue(FrameTubes/HeadTube/Diameter)                            
    puts " ... [bikeGeometry::get_Scalar           HeadTube Length                   ]"               ;# set _lastValue(FrameTubes/HeadTube/Length)                              
    puts " ... [bikeGeometry::get_Scalar           Lugs BottomBracket_ChainStay_Angle        ]"       ;# set _lastValue(Lugs/BottomBracket/ChainStay/Angle/value)                
    puts " ... [bikeGeometry::get_Scalar           Lugs BottomBracket_ChainStay_Tolerance    ]"       ;# set _lastValue(Lugs/BottomBracket/ChainStay/Angle/plus_minus)           
    puts " ... [bikeGeometry::get_Scalar           Lugs BottomBracket_DownTube_Angle         ]"       ;# set _lastValue(Lugs/BottomBracket/DownTube/Angle/value)                 
    puts " ... [bikeGeometry::get_Scalar           Lugs BottomBracket_DownTube_Tolerance     ]"       ;# set _lastValue(Lugs/BottomBracket/DownTube/Angle/plus_minus)            
    puts " ... [bikeGeometry::get_Scalar           Lugs HeadLug_Bottom_Angle         ]"               ;# set _lastValue(Lugs/HeadTube/DownTube/Angle/value)                      
    puts " ... [bikeGeometry::get_Scalar           Lugs HeadLug_Bottom_Tolerance     ]"               ;# set _lastValue(Lugs/HeadTube/DownTube/Angle/plus_minus)                 
    puts " ... [bikeGeometry::get_Scalar           Lugs HeadLug_Top_Angle            ]"               ;# set _lastValue(Lugs/HeadTube/TopTube/Angle/value)                       
    puts " ... [bikeGeometry::get_Scalar           Lugs HeadLug_Top_Tolerance        ]"               ;# set _lastValue(Lugs/HeadTube/TopTube/Angle/plus_minus)                  
    puts " ... [bikeGeometry::get_Scalar           Lugs RearDropOut_Angle            ]"               ;# set _lastValue(Lugs/RearDropOut/Angle/value)                            
    puts " ... [bikeGeometry::get_Scalar           Lugs RearDropOut_Tolerance        ]"               ;# set _lastValue(Lugs/RearDropOut/Angle/plus_minus)                       
    puts " ... [bikeGeometry::get_Scalar           Lugs SeatLug_SeatStay_Angle       ]"               ;# set _lastValue(Lugs/SeatTube/SeatStay/Angle/value)                      
    puts " ... [bikeGeometry::get_Scalar           Lugs SeatLug_SeatStay_Tolerance   ]"               ;# set _lastValue(Lugs/SeatTube/SeatStay/Angle/plus_minus)                 
    puts " ... [bikeGeometry::get_Scalar           Lugs SeatLug_TopTube_Angle        ]"               ;# set _lastValue(Lugs/SeatTube/TopTube/Angle/value)                       
    puts " ... [bikeGeometry::get_Scalar           Lugs SeatLug_TopTube_Tolerance    ]"               ;# set _lastValue(Lugs/SeatTube/TopTube/Angle/plus_minus)                  
    puts " ... [bikeGeometry::get_Scalar           RearBrake LeverLength             ]"               ;# set _lastValue(Component/Brake/Rear/LeverLength)                        
    puts " ... [bikeGeometry::get_Scalar           RearBrake Offset                  ]"               ;# set _lastValue(Component/Brake/Rear/Offset)                             
    puts " ... [bikeGeometry::get_Scalar           RearCarrier x                     ]"               ;# set _lastValue(Component/Carrier/Rear/x)                                
    puts " ... [bikeGeometry::get_Scalar           RearCarrier y                     ]"               ;# set _lastValue(Component/Carrier/Rear/y)                                
    puts " ... [bikeGeometry::get_Scalar           RearDerailleur Pulley_teeth       ]"               ;# set _lastValue(Component/Derailleur/Rear/Pulley/teeth)                  
    puts " ... [bikeGeometry::get_Scalar           RearDerailleur Pulley_x           ]"               ;# set _lastValue(Component/Derailleur/Rear/Pulley/x)                      
    puts " ... [bikeGeometry::get_Scalar           RearDerailleur Pulley_y           ]"               ;# set _lastValue(Component/Derailleur/Rear/Pulley/y)                      
    puts " ... [bikeGeometry::get_Scalar           RearDropout Derailleur_x          ]"               ;# set _lastValue(Lugs/RearDropOut/Derailleur/x)                           
    puts " ... [bikeGeometry::get_Scalar           RearDropout Derailleur_y          ]"               ;# set _lastValue(Lugs/RearDropOut/Derailleur/y)                           
    puts " ... [bikeGeometry::get_Scalar           RearDropout OffsetCS              ]"               ;# set _lastValue(Lugs/RearDropOut/ChainStay/Offset)                       
    puts " ... [bikeGeometry::get_Scalar           RearDropout OffsetCSPerp          ]"               ;# set _lastValue(Lugs/RearDropOut/ChainStay/OffsetPerp)                   
    puts " ... [bikeGeometry::get_Scalar           RearDropout OffsetCS_TopView      ]"               ;# set _lastValue(Lugs/RearDropOut/ChainStay/Offset_TopView)               
    puts " ... [bikeGeometry::get_Scalar           RearDropout OffsetSS              ]"               ;# set _lastValue(Lugs/RearDropOut/SeatStay/Offset)                        
    puts " ... [bikeGeometry::get_Scalar           RearDropout OffsetSSPerp          ]"               ;# set _lastValue(Lugs/RearDropOut/SeatStay/OffsetPerp)                    
    puts " ... [bikeGeometry::get_Scalar           RearDropout RotationOffset        ]"               ;# set _lastValue(Lugs/RearDropOut/RotationOffset)                         
    puts " ... [bikeGeometry::get_Scalar           RearFender Height                 ]"               ;# set _lastValue(Component/Fender/Rear/Height)                            
    puts " ... [bikeGeometry::get_Scalar           RearFender OffsetAngle            ]"               ;# set _lastValue(Component/Fender/Rear/OffsetAngle)                       
    puts " ... [bikeGeometry::get_Scalar           RearFender Radius                 ]"               ;# set _lastValue(Component/Fender/Rear/Radius)                            
    puts " ... [bikeGeometry::get_Scalar           RearMockup CassetteClearance      ]"               ;# set _lastValue(Rendering/RearMockup/CassetteClearance)                  
    puts " ... [bikeGeometry::get_Scalar           RearMockup ChainWheelClearance    ]"               ;# set _lastValue(Rendering/RearMockup/ChainWheelClearance)                
    puts " ... [bikeGeometry::get_Scalar           RearMockup CrankClearance         ]"               ;# set _lastValue(Rendering/RearMockup/CrankClearance)                     
    puts " ... [bikeGeometry::get_Scalar           RearMockup DiscClearance          ]"               ;# set _lastValue(Rendering/RearMockup/DiscClearance)                      
    puts " ... [bikeGeometry::get_Scalar           RearMockup DiscDiameter           ]"               ;# set _lastValue(Rendering/RearMockup/DiscDiameter)                       
    puts " ... [bikeGeometry::get_Scalar           RearMockup DiscOffset             ]"               ;# set _lastValue(Rendering/RearMockup/DiscOffset)                         
    puts " ... [bikeGeometry::get_Scalar           RearMockup DiscWidth              ]"               ;# set _lastValue(Rendering/RearMockup/DiscWidth)                          
    puts " ... [bikeGeometry::get_Scalar           RearMockup TyreClearance          ]"               ;# set _lastValue(Rendering/RearMockup/TyreClearance)                      
    puts " ... [bikeGeometry::get_Scalar           RearWheel FirstSprocket           ]"               ;# set _lastValue(Component/Wheel/Rear/FirstSprocket)                      
    puts " ... [bikeGeometry::get_Scalar           RearWheel HubWidth                ]"               ;# set _lastValue(Component/Wheel/Rear/HubWidth)                           
    puts " ... [bikeGeometry::get_Scalar           RearWheel RimDiameter             ]"               ;# set _lastValue(Component/Wheel/Rear/RimDiameter)                        
    puts " ... [bikeGeometry::get_Scalar           RearWheel RimHeight               ]"               ;# set _lastValue(Component/Wheel/Rear/RimHeight)                          
    puts " ... [bikeGeometry::get_Scalar           RearWheel TyreHeight              ]"               ;# set _lastValue(Component/Wheel/Rear/TyreHeight)                         
    puts " ... [bikeGeometry::get_Scalar           RearWheel TyreShoulder            ]"               ;# set _lastValue(Result/Length/RearWheel/TyreShoulder)                    
    puts " ... [bikeGeometry::get_Scalar           RearWheel TyreWidth               ]"               ;# set _lastValue(Component/Wheel/Rear/TyreWidth)                          
    puts " ... [bikeGeometry::get_Scalar           RearWheel TyreWidthRadius         ]"               ;# set _lastValue(Component/Wheel/Rear/TyreWidthRadius)                    
    puts " ... [bikeGeometry::get_Scalar           Reference HandleBar_Distance      ]"               ;# set _lastValue(Reference/HandleBar_Distance)                            
    puts " ... [bikeGeometry::get_Scalar           Reference HandleBar_Height        ]"               ;# set _lastValue(Reference/HandleBar_Height)                              
    puts " ... [bikeGeometry::get_Scalar           Reference SaddleNose_Distance     ]"               ;# set _lastValue(Reference/SaddleNose_Distance)                           
    puts " ... [bikeGeometry::get_Scalar           Reference SaddleNose_HB           ]"               ;# set _lastValue(Result/Length/Reference/SaddleNose_HB)                   
    puts " ... [bikeGeometry::get_Scalar           Reference SaddleNose_HB_y         ]"               ;# set _lastValue(Result/Length/Reference/Heigth_SN_HB)                    
    puts " ... [bikeGeometry::get_Scalar           Reference SaddleNose_Height       ]"               ;# set _lastValue(Reference/SaddleNose_Height)                             
    puts " ... [bikeGeometry::get_Scalar           Result Angle_HeadTubeTopTube      ]"               ;# set _lastValue(Result/Angle/HeadTube/TopTube)                           
    puts " ... [bikeGeometry::get_Scalar           Saddle SaddleHeight               ]"               ;# set _lastValue(Personal/Saddle_Height)                                  
    puts " ... [bikeGeometry::get_Scalar           Saddle NoseLength                 ]"               ;# set _lastValue(Component/Saddle/LengthNose)                             
    puts " ... [bikeGeometry::get_Scalar           Saddle Offset_x                   ]"               ;# set _lastValue(Rendering/Saddle/Offset_X)                               
    puts " ... [bikeGeometry::get_Scalar           Saddle Offset_y                   ]"               ;# set _lastValue(Rendering/Saddle/Offset_Y)                               
    puts " ... [bikeGeometry::get_Scalar           Saddle SaddleHeight               ]"               ;# set _lastValue(Component/Saddle/Height)                                 
    puts " ... [bikeGeometry::get_Scalar           SeatPost Diameter                 ]"               ;# set _lastValue(Component/SeatPost/Diameter)                             
    puts " ... [bikeGeometry::get_Scalar           SeatPost PivotOffset              ]"               ;# set _lastValue(Component/SeatPost/PivotOffset)                          
    puts " ... [bikeGeometry::get_Scalar           SeatPost Setback                  ]"               ;# set _lastValue(Component/SeatPost/Setback)                              
    puts " ... [bikeGeometry::get_Scalar           SeatStay DiameterCS               ]"               ;# set _lastValue(FrameTubes/SeatStay/DiameterCS)                          
    puts " ... [bikeGeometry::get_Scalar           SeatStay DiameterST               ]"               ;# set _lastValue(FrameTubes/SeatStay/DiameterST)                          
    puts " ... [bikeGeometry::get_Scalar           SeatStay OffsetTT                 ]"               ;# set _lastValue(Custom/SeatStay/OffsetTT)                                
    puts " ... [bikeGeometry::get_Scalar           SeatStay SeatTubeMiterDiameter    ]"               ;# set _lastValue(Lugs/SeatTube/SeatStay/MiterDiameter)                    
    puts " ... [bikeGeometry::get_Scalar           SeatStay TaperLength              ]"               ;# set _lastValue(FrameTubes/SeatStay/TaperLength)                         
    puts " ... [bikeGeometry::get_Scalar           SeatTube Angle                    ]"               ;# set _lastValue(Result/Angle/SeatTube/Direction)                         
    puts " ... [bikeGeometry::get_Scalar           SeatTube DiameterBB               ]"               ;# set _lastValue(FrameTubes/SeatTube/DiameterBB)                          
    puts " ... [bikeGeometry::get_Scalar           SeatTube DiameterTT               ]"               ;# set _lastValue(FrameTubes/SeatTube/DiameterTT)                          
    puts " ... [bikeGeometry::get_Scalar           SeatTube Extension                ]"               ;# set _lastValue(Custom/SeatTube/Extension)                               
    puts " ... [bikeGeometry::get_Scalar           SeatTube OffsetBB                 ]"               ;# set _lastValue(Custom/SeatTube/OffsetBB)                                
    puts " ... [bikeGeometry::get_Scalar           SeatTube TaperLength              ]"               ;# set _lastValue(FrameTubes/SeatTube/TaperLength)                         
    puts " ... [bikeGeometry::get_Scalar           TopTube  DiameterHT               ]"               ;# set _lastValue(FrameTubes/TopTube/DiameterHT)                           
    puts " ... [bikeGeometry::get_Scalar           TopTube DiameterST                ]"               ;# set _lastValue(Custom/TopTube/PivotPosition)                                        
    puts " ... [bikeGeometry::get_Scalar           TopTube OffsetHT                  ]"
    puts " ... [bikeGeometry::get_Scalar           TopTube PivotPosition             ]"
    ...
    puts ""
    compareValues    get_Component  CrankSet                      $::bikeGeometry::CrankSet(File)
    compareValues    get_Scalar     {ChainStay segmentAngle_01}   $::bikeGeometry::ChainStay(segmentAngle_01)
    compareValues    get_Scalar     {ChainStay segmentAngle_02}   $::bikeGeometry::ChainStay(segmentAngle_01)
        #
    puts ""
