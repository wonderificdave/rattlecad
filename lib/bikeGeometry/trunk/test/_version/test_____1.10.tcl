        ...
        proc getObject {index objectOld objectNew {centerPoint {0 0}} } {
            ...
            if {$objectOld != {}} {
                switch -exact $index { 
                    ...
                    bounding {  set oldProcValue [split [::bikeGeometry::get_Value   $objectOld value] ,]}    
            ...
            switch -exact $index {
                ...
                todo {
                            if {[llength $objectNew] > 1} {
                                ...
                                set key         [lindex $objectNew 1]
                                    # puts "    ... $object $key"
                                set returnValue [get_toRefactor $object $key]
                            } else {
                                    # puts "    ... $objectNew"
                                set returnValue [get_toRefactor $objectNew]
                            }
                        }
                ...
                bounding {
                            set returnValue     [get_BoundingBox  $objectNew ]
                        }
                default    {             
...
set RearHub_Position    {600 50}
    ...
    rattleCAD::model::getObject     position    {}                                  LegClearance                                $BB_Position
    # exit
    ...
    rattleCAD::model::getObject     polygon     {}                                  ChainStayRearMockup                         {0 0}
    # exit                               
    puts "\n -- component --\n"                                                                                
    ...
    rattleCAD::model::getObject     component   Lugs/RearDropOut/File               {RearDropout File}
    rattleCAD::model::getObject     component   {}                                  {Fork CrownFile}
    rattleCAD::model::getObject     component   {}                                  {Fork DropOutFile}
    # exit
    ...
    rattleCAD::model::getObject     value       Component/BottleCage/SeatTube/OffsetBB                  {BottleCage SeatTube}
    rattleCAD::model::getObject     value       Component/BottleCage/DownTube/OffsetBB                  {BottleCage DownTube}
    rattleCAD::model::getObject     value       Component/BottleCage/DownTube_Lower/OffsetBB            {BottleCage DownTube_Lower}
    # exit
    ...
    rattleCAD::model::getObject     value       Custom/WheelPosition/Rear                               {RearWheel DistanceBB}
    # exit
    ...
    rattleCAD::model::getObject     value       FrameTubes/ChainStay/Profile/cuttingLeft                {ChainStay cuttingLeft}
    # exit
    ...
    rattleCAD::model::getObject     value       Result/Length/SeatTube/VirtualLength                    {Geometry SeatTubeVirtual}
    rattleCAD::model::getObject     value       Result/Length/TopTube/VirtualLength                     {Geometry TopTubeVirtual}
    # exit
    ...
    rattleCAD::model::getObject     rendering   Lugs/RearDropOut/Direction                              {RearDropoutOrient}
    # exit
    
    rattleCAD::model::getObject     bounding    Result/Position/SummarySize                             {SummarySize}

    rattleCAD::model::getObject     todo        Result/Tubes/ChainStay/RearMockup/CenterLine            {RearMockup CenterLine}
    rattleCAD::model::getObject     todo        Result/Tubes/ChainStay/RearMockup/CenterLineUnCut       {RearMockup CenterLineUnCut}
    rattleCAD::model::getObject     todo        Result/Tubes/ChainStay/RearMockup/CtrLines              {RearMockup CtrLines}
    ...
    rattleCAD::model::getObject     todo        Result/Tubes/ChainStay/RearMockup/CenterLine            Result/Tubes/ChainStay/RearMockup/CenterLine
    rattleCAD::model::getObject     todo        Result/Tubes/ChainStay/RearMockup/CenterLineUnCut       Result/Tubes/ChainStay/RearMockup/CenterLineUnCut
    rattleCAD::model::getObject     todo        Result/Tubes/ChainStay/RearMockup/CtrLines              Result/Tubes/ChainStay/RearMockup/CtrLines
