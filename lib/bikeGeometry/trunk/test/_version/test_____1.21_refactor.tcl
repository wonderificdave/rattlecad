...
puts "\n\n ====== I N I T ============================ \n\n"
    ...
    compareValues    get_Scalar     {Fork Height                }   $::bikeGeometry::Fork(Height)                       Component(Fork/Height)                ;# set _lastValue(Component/Fork/Height)                                   
    compareValues    get_Scalar     {Fork Rake                  }   $::bikeGeometry::Fork(Rake)                         Component(Fork/Rake)                  ;# set _lastValue(Component/Fork/Rake)                                     
        #   
    reportComparison
        #
    ...
    compareValues    get_Scalar     {FrontWheel RimDiameter      }  $::bikeGeometry::FrontWheel(RimDiameter)            Component(Wheel/Front/RimDiameter)       ;# set _lastValue(Component/Wheel/Front/RimDiameter)                       
    ...
    compareValues    get_Scalar     {FrontWheel TyreHeight       }  $::bikeGeometry::FrontWheel(TyreHeight)             Component(Wheel/Front/TyreHeight)        ;# set _lastValue(Component/Wheel/Front/TyreHeight)                        
        #
    reportComparison
        #
    ...
    compareValues    get_Scalar     {RearWheel RimDiameter         }  $::bikeGeometry::RearWheel(RimDiameter)           Component(Wheel/Rear/RimDiameter)           ;# set _lastValue(Component/Wheel/Rear/RimDiameter)                        
    ...
    compareValues    get_Scalar     {RearWheel TyreHeight          }  $::bikeGeometry::RearWheel(TyreHeight)            Component(Wheel/Rear/TyreHeight)            ;# set _lastValue(Component/Wheel/Rear/TyreHeight)                         
    ...
    compareValues    get_Scalar     {TopTube OffsetHT              }  $::bikeGeometry::TopTube(OffsetHT)                FrameTubes(TopTube/OffsetHT)
