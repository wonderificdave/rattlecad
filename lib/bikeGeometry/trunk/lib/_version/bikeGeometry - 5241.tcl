 ...
 #          add get_TubeMiter
 # 1.12 rename fork handling 
 #
  
    package require tdom
        #
    package provide bikeGeometry 1.12
        #
    ...
    namespace eval bikeGeometry {
            ...
            namespace export get_ListBoxValues 
                #
            namespace export get_toRefactor
                #
            ...
            switch -exact $index {
                ...
                polygon {    
                            ...
                            switch -exact $object {
                                ...
                                default { 
                                        set branch  {}
                                        puts "\n   <E> ... bikeGeometry::get_Object polygon: \$object $object"
                ...
                position {
                            ...
                            switch -exact $object {
                                ...
                                default { 
                                            set branch  {}
                                            puts "\n   <E> ... bikeGeometry::get_Object position: \$object $object"
                ...
                direction {
                            ...
                            switch -glob $object {
                                ...
                                default { 
                                        set branch {}
                                        puts "\n   <E> ... bikeGeometry::get_Object direction: \$object $object"
    ...
    proc bikeGeometry::get_TubeMiter {object} {
        ...
        #
    proc bikeGeometry::get_toRefactor {object {key {}}} {
                # 
            set returnString {}
                #
                # puts " .. $object\n"
