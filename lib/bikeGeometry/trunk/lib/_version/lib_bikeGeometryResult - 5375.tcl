 ...
 #
    ...
    proc bikeGeometry::set_resultParameter {_array _name value} {
            ...
            switch -exact $_name {
                ...
                {Angle_HeadTubeTopTube}         {   bikeGeometry::set_Result_HeadTube_TopTubeAngle  $_array $_name  $value; return  }
    ...
    proc bikeGeometry::set_Result_HeadTube_TopTubeAngle {value} {
            ...
            variable TopTube    
                #
            puts "    <1> set_Result_HeadTube_TopTubeAngle   ... check $Geometry(Angle_HeadTubeTopTube)  ->  $value"
                #
            ...
            bikeGeometry::update_Project
                #
            puts "    <2> set_Result_HeadTube_TopTubeAngle   ... check $Geometry(Angle_HeadTubeTopTube)  ->  $value"
                #
            return $Geometry(Angle_HeadTubeTopTube)
                #
    }
    ...
    proc bikeGeometry::set_Result_TopTubeVirtualLength  {_array _name value} {
            ...
            variable HandleBar
                #
            puts "    <1> set_Result_TopTubeVirtualLength   ... check $Geometry(TopTubeVirtual)  ->  $value"
                #
           set delta                            [expr $value - $Geometry(TopTubeVirtual)]
            ...
            bikeGeometry::update_Project
                #
            puts "    <2> set_Result_TopTubeVirtualLength   ... check $Geometry(TopTubeVirtual)  ->  $value"
                #
