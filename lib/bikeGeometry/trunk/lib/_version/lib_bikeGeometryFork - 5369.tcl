 ...
 #
    ...
    proc bikeGeometry::create_Fork {} {
            ...
            switch -glob $Config(Fork) {
                ...
                #
            puts "  bikeGeometry::create_Fork   \$Config(Fork)            $Config(Fork)  "
            puts "  bikeGeometry::create_Fork   \$Component(ForkCrown)    $Component(ForkCrown)  "
            puts "  bikeGeometry::create_Fork   \$Component(ForkDropout)  $Component(ForkDropout)"
    ...
    proc bikeGeometry::create_Fork_SteelCustom {} {
            ...
            set pt_99       $Fork(DropoutPosition)
            ...
            dict append dict_ForkBlade env \
                    [list dropOutPosition $Fork(DropoutPosition) \
            ...
            set forkBladePos    [lindex $retValue 4]
                #
            set dropOutPos      $Fork(DropoutPosition) 
                #
    ...
    proc bikeGeometry::create_compositeFork {forkType} {
            ...
            set vct_19              [ vectormath::parallel $pt_00 $pt_02 [expr 0.5*$Fork(BladeWidth)] ]
                    ...
                    # puts "   -> vct_19  $vct_19"
                #
            set help_02         [ list 0 [lindex  $Fork(DropoutPosition) 1] ]
            set do_angle        [ expr 90 - [ vectormath::angle $pt_01 $Fork(DropoutPosition) $help_02  ] ]
            set vct_05          [ list $Fork(BladeOffsetDO) 0 ]
            set vct_06          [ vectormath::rotatePoint {0 0} $vct_05 [expr 90 + $do_angle] ]
                #
            set pt_03           [ vectormath::addVector $Fork(DropoutPosition)  $vct_06 ]
                #
            ...
            if {$forkType == {TUSK}} {
                ...
                #
            set do_angle       [ vectormath::angle $pt_01 $Fork(DropoutPosition) $help_02  ] 
