 ...
 #
    ...
    proc bikeGeometry::set_to_project {} {
            ...
            project::setValue Result(Tubes/ChainStay/Profile/xy)                    value       $Polygon(ChainStay_zx)                                 
            ...
            project::setValue Result(Tubes/ChainStay/RearMockup/Start)              value       [list $Position(ChainStay_RearMockup)]                         
