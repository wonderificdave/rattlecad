 ...
 #
    ...
    proc bikeGeometry::geometry::fill_resultValues {} {
            ...
            set Geometry(BottomBracket_ChainStay_Angle) [format "%.4f" [ get_resultAngle $BB_Position           $TopTube(SeatTube)  $ChainSt_SeatSt_IS  ]]  ;# Result(Angle/BottomBracket/ChainStay)
            set Geometry(SeatLug_Angle_SeatStay)        [format "%.4f" [ get_resultAngle $ChainSt_SeatSt_IS     $BB_Position        $SeatStay(SeatTube) ]]  ;# Result(Angle/SeatStay/ChainStay)                 
                #
                # --- Reference Position ------------------------------
                #             
