 ...
 #
   ...
   # compareValue        get_Value   Lugs/BottomBracket/ChainStay/Angle/plus_minus       value                            get_Scalar         {Lugs BottomBracket/ChainStay/Angle/plus_minus} 
   # compareValue        get_Value   Lugs/BottomBracket/ChainStay/Angle/value            value                            get_Scalar         {Lugs BottomBracket/ChainStay/Angle/value} 
   # compareValue        get_Value   Lugs/BottomBracket/DownTube/Angle/plus_minus        value                            get_Scalar         {Lugs BottomBracket/DownTube/Angle/plus_minus } 
   # compareValue        get_Value   Lugs/BottomBracket/DownTube/Angle/value             value                            get_Scalar         {Lugs BottomBracket/DownTube/Angle/value} 
   # compareValue        get_Value   Lugs/HeadTube/DownTube/Angle/plus_minus             value                            get_Scalar         {Lugs HeadTube/DownTube/Angle/plus_minus} 
   # compareValue        get_Value   Lugs/HeadTube/DownTube/Angle/value                  value                            get_Scalar         {Lugs HeadTube/DownTube/Angle/value} 
   # compareValue        get_Value   Lugs/HeadTube/TopTube/Angle/plus_minus              value                            get_Scalar         {Lugs HeadTube/TopTube/Angle/plus_minus} 
   # compareValue        get_Value   Lugs/HeadTube/TopTube/Angle/value                   value                            get_Scalar         {Lugs HeadTube/TopTube/Angle/value} 
   # compareValue        get_Value   Lugs/RearDropOut/Angle/plus_minus                   value                            get_Scalar         {Lugs RearDropOut/Angle/plus_minus} 
   # compareValue        get_Value   Lugs/RearDropOut/Angle/value                        value                            get_Scalar         {Lugs RearDropOut/Angle/value} 
   # compareValue        get_Value   Lugs/SeatTube/SeatStay/Angle/plus_minus             value                            get_Scalar         {Lugs SeatTube/SeatStay/Angle/plus_minus} 
   # compareValue        get_Value   Lugs/SeatTube/SeatStay/Angle/value                  value                            get_Scalar         {Lugs SeatTube/SeatStay/Angle/value} 
            ...
            if {$Saddle(SaddleHeight) < 0} {
                ...
                # set project::Component(Saddle/Height) $Saddle(SaddleHeight) 
            }
            ...
            # set RearHub(File)                 $project::Component(Hub/File)      
                ...
                #
                # --- get result  -------------------------------
            # set Result(Angle_HeadTubeTopTube)  $project::Result(Angle/HeadTube/TopTube)
    ...
    proc bikeGeometry::set_to_project {} {
            ...
            project::setValue Custom(WheelPosition/Rear)                            value       $RearWheel(DistanceBB)
