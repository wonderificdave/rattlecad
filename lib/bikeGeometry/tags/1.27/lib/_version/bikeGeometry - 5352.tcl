 ...
 #
    ...
    proc bikeGeometry::get_projectDICT {} {
        ...
        dict set returnDict Component   BottleCage_SeatTube                 $::bikeGeometry::Component(BottleCage_SeatTube)                                
            #                           
        dict set returnDict Config      BottleCage_DT                       $::bikeGeometry::Config(BottleCage_DT)                          ;#[bikeGeometry::get_Config           BottleCage_DT                     ]                ;# set _lastValue(Rendering/BottleCage/DownTube)                           
        dict set returnDict Config      BottleCage_DT_L                     $::bikeGeometry::Config(BottleCage_DT_L)                        ;#[bikeGeometry::get_Config           BottleCage_DT_L                   ]                ;# set _lastValue(Rendering/BottleCage/DownTube_Lower)                     
        dict set returnDict Config      BottleCage_ST                       $::bikeGeometry::Config(BottleCage_ST)                          ;#[bikeGeometry::get_Config           BottleCage_ST                     ]                ;# set _lastValue(Rendering/BottleCage/SeatTube)                           
        ...
        dict set returnDict Scalar      Geometry ReachLengthResult          $::bikeGeometry::Geometry(ReachLengthResult)                    ;#[bikeGeometry::get_Scalar           Geometry ReachLengthResult        ]                ;# set _lastValue(Result/Length/HeadTube/ReachLength)                      
        ...
        dict set returnDict Scalar      Geometry SeatTubeVirtual            $::bikeGeometry::Geometry(SeatTubeVirtual)                      ;#[bikeGeometry::get_Scalar           Geometry SeatTubeVirtual          ]                ;# set _lastValue(Result/Length/SeatTube/VirtualLength)                    
        dict set returnDict Scalar      Geometry StackHeightResult          $::bikeGeometry::Geometry(StackHeightResult)                    ;#[bikeGeometry::get_Scalar           Geometry StackHeightResult        ]                ;# set _lastValue(Result/Length/HeadTube/StackHeight)                      
        ...
        dict set returnDict Scalar      Geometry TopTubeVirtual             $::bikeGeometry::Geometry(TopTubeVirtual)                       ;#[bikeGeometry::get_Scalar           Geometry TopTubeVirtual           ]                ;# set _lastValue(Result/Length/TopTube/VirtualLength)                     
        ...
        dict set returnDict Scalar      Reference   SaddleNose_Height           $::bikeGeometry::Reference(SaddleNose_Height)               ;#[bikeGeometry::get_Scalar           Reference SaddleNose_Height       ]                ;# set _lastValue(Reference/SaddleNose_Height)                             
            #            
        dict set returnDict Scalar      Result      Angle_HeadTubeTopTube       $::bikeGeometry::Result(Angle_HeadTubeTopTube)              ;#[bikeGeometry::get_Scalar           Result Angle_HeadTubeTopTube      ]                ;# set _lastValue(Result/Angle/HeadTube/TopTube)                           
        ...
        dict set returnDict Scalar      SeatStay    TaperLength                 $::bikeGeometry::SeatStay(TaperLength)                      ;#[bikeGeometry::get_Scalar           SeatStay TaperLength              ]                ;# set _lastValue(FrameTubes/SeatStay/TaperLength)                         
            #            
        dict set returnDict Scalar      SeatTube    Angle                       $::bikeGeometry::SeatTube(Angle)                            ;#[bikeGeometry::get_Scalar           SeatTube Angle                    ]                ;# set _lastValue(Result/Angle/SeatTube/Direction)                         
    ...
    proc bikeGeometry::get_projectDICT_old {} {
        ...
        dict set returnDict ListValue   CrankSet_ChainRings                             [bikeGeometry::get_ListValue        CrankSet_ChainRings               ]                ;# set _lastValue(Component/CrankSet/ChainRings)                           
    ...
    proc bikeGeometry::get_Component_old {object {key {File}}} {
                #
            set componentFile {}
                #
                # puts " .. $object\n"
    ...
    proc bikeGeometry::set_Component {key} {
                #
            set componentFile {}
                #
                # puts " .. $key\n"
            ...
            switch -exact $key {
                ...
                RearDerailleur -
                RearDropout -
                Saddle                      { array set [namespace current]::$key    File                $value }                
                ...
                default {
                        puts "\n"
                        puts "        <W> .... bikeGeometry::get_Component $key $key"
                        puts "\n"
                        return {}
                    }                
            }
                #
            set returnValue [bikeGeometry::get_Component $key]
                #
            return $returnValue
                #
    }
    ...
    proc bikeGeometry::get_Config {key} {
                #
            set optionValue  [lindex [array get [namespace current]::Config $key] 1]
            return $optionValue
                #
    }  
    proc bikeGeometry::set_Config {key value} {
            ...
            set returnValue {}
                # puts " .. $key\n"
            set [namespace current]::Rendering($key) $value
                #
            set returnValue [bikeGeometry::get_Config $key]
                #
            return $returnValue
                #
    }  
