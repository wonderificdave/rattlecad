 ...
 #
    ...
    proc bikeGeometry::get_projectDICT {} {
        ...
        dict set returnDict Scalar      Geometry TopTube_Angle              $::bikeGeometry::Geometry(TopTube_Angle)                        ;#[bikeGeometry::get_Scalar           Geometry TopTube_Angle            ]                ;# set _lastValue(Custom/TopTube/Angle)                                    
            #            
        dict set returnDict Scalar      Geometry Angle_HeadTubeTopTube      $::bikeGeometry::Geometry(Angle_HeadTubeTopTube)                ;#[bikeGeometry::get_Scalar           Result Angle_HeadTubeTopTube      ]                ;# set _lastValue(Result/Angle/HeadTube/TopTube)                           
            #
        ...
        switch -exact $object {
            Geometry {
                    switch -exact $key {
                        ...
                        {Angle_HeadTubeTopTube}             {   bikeGeometry::set_Result_HeadTube_TopTubeAngle  $newValue; return [get_Scalar $object $key] }
                        
                        default {return {}}
                    }
                    
                    return [bikeGeometry::get_Scalar $object $key]
                }
            Result {
                    set newValue [set_resultParameter Result $key $newValue]
