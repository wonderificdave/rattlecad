 ...
 #
    ...
    proc bikeGeometry::get_Fork {} {
        ...
        #       #
        #   set Fork(CrownFile)             $myFork(CrownFile)                              
        #   set Fork(DropOutFile)           $myFork(DropOutFile)        
        #       #                                                                               
        #   set Fork(CrownBrakeOffset)      $myFork(CrownBrakeOffset)   
        #   set Fork(CrownBrakeAngle)       $myFork(CrownBrakeAngle)    
        #       #                                                                                 
        #   set Fork(BladeBrakeOffset)      $myFork(BladeBrakeOffset)   
                #
                #
            return
                #
    ...
    proc bikeGeometry::get_Fork_SteelLuggedMAX {} {
            ...
            set myFork(BladeWidth)        [[ $initDOM selectNodes /root/Fork/SteelLuggedMAX/Blade/Width            ]  asText ]
            ...
            dict append dict_ForkBlade profile \
                    [list [list 0                         $myFork(BladeDiameterDO)] \
                          [list $myFork(BladeTaperLength) $myFork(BladeWidth)] \
                          [list 200                       $myFork(BladeWidth)] \
                          [list 500                       $myFork(BladeWidth)] \
                    ]
    ...
    proc bikeGeometry::get_Fork_Composite {} {
            ...
            # set myFork(BladeBrakeOffset)  [[ $initDOM selectNodes /root/Fork/Composite/Brake/Offset       ]  asText ]  
                #
            set pt_60  [ vectormath::rotateLine $pt_00  $Fork(CrownBrakeOffset)  [expr  90 - $HeadTube(Angle)]]
