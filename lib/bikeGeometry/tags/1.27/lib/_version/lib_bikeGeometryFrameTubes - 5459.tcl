 ...
 #
    ...
    proc bikeGeometry::create_ChainStay_RearMockup {} {
            ...
            set Polygon(ChainStayRearMockup)               $outLine
                # puts $outLine
            ...
            set CenterLine(RearMockup_UnCut)    [format_XcommaY $centerLineUnCut]
                ...
                # puts "\n===================\n -> \$outLine $outLine\n"
                # puts "  \$CenterLine(RearMockup) $CenterLine(RearMockup)"
                # puts "  \$CenterLine(RearMockup_UnCut) $CenterLine(RearMockup_UnCut)"
    ...
    proc bikeGeometry::create_TopTube_SeatTube {} {
            ...
            set vct_st      [ vectormath::parallel          $SeatTube(DownTube) $Position(SeatPost_SeatTube) [expr 0.5*$SeatTube(DiameterTT)] ]
                    # set vct_st    [ vectormath::parallel          $SeatTube(BottomBracket) $Position(SeatPost_SeatTube) [expr 0.5*$SeatTube(DiameterTT)] ]
            ...
            # set Result(Tubes/TopTube/Direction)       [ vectormath::rotatePoint {0 0} {-1 0} $Geometry(TopTube_Angle) ]    ;# direction vector of TopTube
                    ...
                    set pt_02       [ vectormath::intersectPoint    $pt_01 [vectormath::addVector $pt_01  $TopTube(Direction)]  {0 0} $Position(SeatPost_SeatTube) ]    ;# top intersection TopTube/HeadTube
            ...
            set TopTube(SeatTube)   [ vectormath::intersectPoint [lindex $vct_00 0] [lindex $vct_00 1] $SeatTube(BottomBracket) $Position(SeatPost_SeatTube) ]
            ...
            # set Result(Tubes/TopTube/Polygon)                [project::flatten_nestedList $polygon]
                        ...
                        # 
                    set pt_00       [ vectormath::intersectPerp     $SeatTube(BottomBracket) $Position(SeatPost_SeatTube)   $pt_st ]
            ...
            # set Result(Tubes/TopTube/Profile/xy)  [list [project::getValue Result(Tubes/TopTube/Profile/xz) value]]
              #
                        ...
                        #
                    # set SeatTube(Direction)        [ vectormath::unifyVector $SeatTube(DownTube) $Position(SeatPost_SeatTube) ]
                        #
    ...
    proc bikeGeometry::create_DownTube_SeatTube {} {
            ...
            variable Result
                ...
                set pt_is       [ vectormath::intersectPoint    [lindex $vct_cl 0] [lindex $vct_cl 1]  $SeatTube(BottomBracket)    $Position(SeatPost_SeatTube) ]
                    #
