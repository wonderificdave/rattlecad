 ...
 #
        ...
        #
    proc frameGeometry::get_basePoints {} {
            variable Saddle
            variable SeatPost
            variable SeatTube
            variable HandleBar
        ...
        #
        # --- set ChainStay ------------------------
    proc frameGeometry::get_ChainStay {} {
            variable RearDrop
            variable ChainStay
            variable RearWheel
        ...
        #
        # --- set HeadTube -------------------------
    proc frameGeometry::get_HeadTube {} {
            variable HeadTube
            variable HeadSet
            variable Steerer
        ...
        #
        # --- set TopTube -------------------------
    proc frameGeometry::get_TopTube_SeatTube {} {
            variable TopTube
            variable HeadTube
            variable SeatTube
            variable DownTube
    ...
    proc frameGeometry::get_DownTube_SeatTube {} {
            variable HeadTube
            variable DownTube
            variable SeatTube
            variable SeatPost
        ...
        #
        # --- set SeatStay ------------------------
    proc frameGeometry::get_SeatStay {} {
            variable SeatStay
            variable ChainStay
            variable TopTube
            variable SeatTube
    ...
    proc frameGeometry::get_Fork {} {
        ...
        #
        # --- set Steerer -------------------------
    proc frameGeometry::get_Steerer {} {
            variable HeadTube
            variable Steerer
        ...
        #
        # --- set SeatPost ------------------------
    proc frameGeometry::get_SeatPost {} {
            variable Saddle
            variable SeatPost
            variable TopTube
            variable SeatTube
        ...
        #
        # --- set HeadSet -------------------------
    proc frameGeometry::get_HeadSet {} {
            variable HeadTube
            variable HeadSet
            variable Steerer
    ...
    proc frameGeometry::get_Stem {} {
        ...
        #
        # --- fill Result Values ------------------
    proc frameGeometry::fill_resultValues {} {
            variable BottomBracket
            variable HeadTube
            variable TopTube
            variable Steerer
            ...
            set position    $HeadTube(Stem)
                    ...
                    #
                    # puts "                ... [ frameGeometry::get_Object     HeadTube Stem           {0 0} ]"
                set value       [ format "%.3f" [lindex $position 0] ]
                    # puts "                  ... $value"
                ...
                # --- SeatTube ----------------------------------------
                    #
            set position    [ frameGeometry::get_Object     SeatTube/End    position    {0 0} ]
            ...
            project::setValue Result(Angle/SeatTube/Direction) value $angle
                    ...
                    # --- SeatTube/TubeLength -------------------------
                    #
                    # puts "                   ... [ frameGeometry::get_Object        SeatTube TopTube    {0 0} ]"
            ...
            set BB_Position             {0 0}
            set SeatStay(SeatTube)      [ frameGeometry::get_Object     SeatStay/End            position ]
            set TopTube(SeatTube)       [ frameGeometry::get_Object     TopTube/Start           position ]
            set TopTube(Steerer)        [ frameGeometry::get_Object     TopTube/End             position ]
            set Steerer(Stem)           [ frameGeometry::get_Object     Steerer/End             position ]
            set Steerer(Fork)           [ frameGeometry::get_Object     Steerer/Start           position ]
            set DownTube(Steerer)       [ frameGeometry::get_Object     DownTube/End            position ]
            set DownTube(BBracket)      [ frameGeometry::get_Object     DownTube/Start          position ]
            set ChainSt_SeatSt_IS       [ frameGeometry::get_Object     ChainStay/SeatStay_IS   position ]
    ...
    proc frameGeometry::get_DerailleurMountFront {} {
            variable SeatTube
    ...
    proc frameGeometry::get_BrakePositionRear {} {
            variable RearBrake
            variable RearWheel
            variable SeatStay
    ...
    proc frameGeometry::get_BrakePositionFront {} {
        ...
        #
        # --- set BottleCageMount ------------------
    proc frameGeometry::get_BottleCageMount {} {
            variable BottleCage
            variable SeatTube
            variable DownTube
        ...
        #
        # --- set FrameJig ------------------------
    proc frameGeometry::get_FrameJig {} {
            variable FrameJig
            variable RearWheel
            variable Steerer
            variable SeatPost
        ...
        #
        # --- set TubeMiter -----------------
    proc frameGeometry::get_TubeMiter {} {
            variable HeadTube
            variable SeatTube
            variable SeatStay
            variable TopTube
            ...
            variable TubeMiter
                    ...
                    set dir         [ vectormath::scalePointList {0 0} [ frameGeometry::get_Object HeadTube direction ] -1.0 ]
                        # puts " .. \$dir $dir"
            ...
            set TubeMiter(DownTube_Head)        [ tube_miter    $DownTube(DiameterHT) $DownTube(Direction)    $HeadTube(Diameter)        $HeadTube(Direction)    $DownTube(HeadTube) right    0    opposite]
                    set offset        [ expr 0.5 * ($SeatTube(DiameterTT) - $SeatStay(DiameterST)) ]
                    set dir         [ vectormath::scalePointList {0 0} [ frameGeometry::get_Object SeatStay direction ] -1.0 ]
                        # puts " .. \$dir $dir"
    ...
    proc frameGeometry::set_columbusMAXFork {} {
    
            variable FrontWheel
            variable Fork
            
            set domInit $::APPL_Config(root_InitDOM)
            set FrontWheel(position)    [ frameGeometry::get_Object        FrontWheel        position    {0 0}]
            set Steerer_Fork(position)  [ frameGeometry::get_Object        Steerer/Start    position    {0 0}]
            set ht_direction            [ frameGeometry::get_Object        HeadTube        direction ]
    ...
    #-------------------------------------------------------------------------
        #  Fork Blade Polygon for composite Fork
    proc frameGeometry::set_compositeFork {} {
    ...
    proc frameGeometry::set_suspensionFork {} {
     ...
     #-------------------------------------------------------------------------
        ...
        #                \     \     \ diameter_isect
        #
    proc frameGeometry::tube_intersection { diameter direction diameter_isect direction_isect isectionPoint {side {right}} {offset {0}} } {
    ...
    #-------------------------------------------------------------------------
        ...
        #                \     \     \ diameter_isect
        #
    proc frameGeometry::tube_miter { diameter direction diameter_isect direction_isect isectionPoint {side {right}} {offset {0}}  {opposite {no}}} {
    ...
    # --- Result Angles  ----------------------------------
        #
    proc frameGeometry::get_resultAngle {position point_1 point_2 } {
