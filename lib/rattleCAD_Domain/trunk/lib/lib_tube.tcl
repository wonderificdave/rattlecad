...
namespace eval lib_tube {
    ...
    proc init_centerLine {centerLineDef} {
        ...
        set segment_01  [expr $S01_radius * $S01_angle * $rc_Domain::vectormath::CONST_PI / 180]
        set segment_02  [expr $S02_radius * $S02_angle * $rc_Domain::vectormath::CONST_PI / 180]
        set segment_03  [expr $S03_radius * $S03_angle * $rc_Domain::vectormath::CONST_PI / 180]
        ...
        lappend basePoints  $p_End
          ...
          # ============================================
          # start-Segment
        set p_S01 [rc_Domain::vectormath::addVector $p_End [rc_Domain::vectormath::rotateLine {0 0} $S01_length $angle_00]]
        ...
        if {$S01_angle == 0} {
            ...
            if {$S01_angle > 0} {
                set p_End    [rc_Domain::vectormath::addVector $p_S01  [rc_Domain::vectormath::rotateLine {0 0} [expr -1.0 * $offset_01] $angle_00]] 
                set p_S01_ct [rc_Domain::vectormath::addVector $p_End  [rc_Domain::vectormath::rotateLine {0 0} $S01_radius  90]]
                lappend basePoints $p_End
            } else {
                set p_End    [rc_Domain::vectormath::addVector $p_S01  [rc_Domain::vectormath::rotateLine {0 0} [expr -1.0 * $offset_01] $angle_00]] 
                set p_S01_ct [rc_Domain::vectormath::addVector $p_End  [rc_Domain::vectormath::rotateLine {0 0} $S01_radius -90]]
            ...
            set i 0
            while {$i < $nrSegments} {
              set p_End  [rc_Domain::vectormath::rotatePoint $p_S01_ct $pStart $deltaAngle]
              lappend basePoints $p_End
          ...
          # 2nd bent-Segment
        if {$S01_angle == 0} { 
            set p_S02 [rc_Domain::vectormath::addVector $p_S01 [rc_Domain::vectormath::rotateLine {0 0} $S02_length $angle_01]]
        } else {
            set length_02 [expr $S02_length - $offset_01]
            set p_S02 [rc_Domain::vectormath::addVector $p_End [rc_Domain::vectormath::rotateLine {0 0} $length_02 $angle_01]]
        } 
        if {$S02_angle == 0} {
            ...
            if {$S02_angle < 0} {
                set p_End    [rc_Domain::vectormath::addVector $p_S02 [rc_Domain::vectormath::rotateLine {0 0} [expr -1.0 * $offset_02] $angle_01]]   
                set p_S02_ct [rc_Domain::vectormath::addVector $p_End [rc_Domain::vectormath::rotateLine {0 0} $S02_radius [expr -1.0*(90 - $angle_01)]]]
            } else {
                set p_End    [rc_Domain::vectormath::addVector $p_S02 [rc_Domain::vectormath::rotateLine {0 0} [expr -1.0 * $offset_02] $angle_01]]   
                set p_S02_ct [rc_Domain::vectormath::addVector $p_End [rc_Domain::vectormath::rotateLine {0 0} $S02_radius [expr (90 + $angle_01)]]]
            }
            set p_S02_a  $p_End
            ...
            set i 0
            while {$i < $nrSegments} {
              set p_End  [rc_Domain::vectormath::rotatePoint $p_S02_ct $pStart $deltaAngle]
              lappend basePoints $p_End
                # puts "  -> i/p_End:  $i  $p_End"
              set pStart $p_End
              incr i
          ...
          # 3rd bent-Segment
        if {$S02_angle == 0} { 
            set p_S03 [rc_Domain::vectormath::addVector $p_S02 [rc_Domain::vectormath::rotateLine {0 0} $S03_length $angle_02]]
        } else {
            set length_03 [expr $S03_length - $offset_02]
            set p_S03 [rc_Domain::vectormath::addVector $p_End [rc_Domain::vectormath::rotateLine {0 0} $length_03 $angle_02]]
        }
        if {$S03_angle == 0} {
            ...
            if {$S03_angle > 0} {
                set p_End  [rc_Domain::vectormath::addVector $p_S03 [rc_Domain::vectormath::rotateLine {0 0} [expr -1.0 * $offset_03] $angle_02]]   
                set p_S03_ct [rc_Domain::vectormath::addVector $p_End [rc_Domain::vectormath::rotateLine {0 0} $S03_radius [expr (90 + $angle_02)]]]
            } else {
                set p_End  [rc_Domain::vectormath::addVector $p_S03 [rc_Domain::vectormath::rotateLine {0 0} [expr -1.0 * $offset_03] $angle_02]]   
                set p_S03_ct [rc_Domain::vectormath::addVector $p_End [rc_Domain::vectormath::rotateLine {0 0} $S03_radius [expr -1.0*(90 - $angle_02)]]]
            }
            set p_S03_a  $p_End
            ...
            set i 0
            while {$i < $nrSegments} {
              set p_End  [rc_Domain::vectormath::rotatePoint $p_S03_ct $pStart $deltaAngle]
              lappend basePoints $p_End
                # puts "  -> i/p_End:  $i  $p_End"
              set pStart $p_End
              incr i
          ...
          # last-Segment
        if {$offset_03 == 0} { 
            set p_S04 [rc_Domain::vectormath::addVector $p_S03 [rc_Domain::vectormath::rotateLine {0 0} $S04_length $angle_03]]
        } else {
            set length_04 [expr $S04_length - $offset_03]
            set p_S04 [rc_Domain::vectormath::addVector $p_End [rc_Domain::vectormath::rotateLine {0 0} $length_04 $angle_03]]
        }
        lappend basePoints $p_S04
        
        
          # -- define controlLines
        set ctrlPoint_00_b [rc_Domain::vectormath::addVector $p_S00 [list  $S01_length 0]]
        
        set ctrlPoint_01_a [rc_Domain::vectormath::addVector $p_S01_b [rc_Domain::vectormath::rotateLine {0 0} $offset_01 [expr 180 + $angle_01]]]
        set ctrlPoint_01_b [rc_Domain::vectormath::addVector $p_S02_a [rc_Domain::vectormath::rotateLine {0 0} $offset_02 $angle_01]]
        
        set ctrlPoint_02_a [rc_Domain::vectormath::addVector $p_S02_b [rc_Domain::vectormath::rotateLine {0 0} $offset_02 [expr 180 + $angle_02]]]
        set ctrlPoint_02_b [rc_Domain::vectormath::addVector $p_S03_a [rc_Domain::vectormath::rotateLine {0 0} $offset_03 $angle_02]]
        
        set ctrlPoint_03_a [rc_Domain::vectormath::addVector $p_S03_b [rc_Domain::vectormath::rotateLine {0 0} $offset_03 [expr 180 + $angle_03]]]
    ...
    proc get_ForkBlade {valueDict} {
        ...
        switch -exact $bladeType {
          ...
          bent {
              ...
              if {$height_bladeDO > $dropOutPerp} {
                  ...
                  set bendAngle [expr (-180/$rc_Domain::vectormath::CONST_PI) * ($_acos + $_atan)]
                  set segLength [expr abs($bendRadius*$bendAngle)*($rc_Domain::vectormath::CONST_PI/180)] 
                  set dirAngle  [expr -1*$bendAngle]
                  
                  set l_t01   [expr $bendRadius * sin($bendAngle*$rc_Domain::vectormath::CONST_PI/180)]
                  
                  set p_01    [rc_Domain::vectormath::rotateLine $p_00 $dropOutPerp    [expr 270 + $dirAngle]]
                  set p_02    [rc_Domain::vectormath::rotateLine $p_01 $dropOutOffset  [expr 180 + $dirAngle]]
                  set p_03    [rc_Domain::vectormath::rotateLine $p_02 $endLength      [expr 180 + $dirAngle]]
                  set p_04    [rc_Domain::vectormath::subVector $p_03  [list           [expr -1 * $l_t01] [lindex $p_03 1]]]
                  set p_05    [rc_Domain::vectormath::rotateLine $p_03 [expr 0.5 * $segLength] [expr 180 + $dirAngle]]
                  set p_06    $orient_03
                  set p_15    [rc_Domain::vectormath::addVector $p_04  [list 0         $bendRadius]]
                  ...
                  set p_02    [rc_Domain::vectormath::rotateLine $p_01 $dropOutOffset  [expr 180 + $dirAngle]]
                  set p_03    [rc_Domain::vectormath::rotateLine $p_02 $endLength      [expr 180 + $dirAngle]]
                  set p_04    [rc_Domain::vectormath::subVector $p_03  [list $l_t01    [lindex $p_03 1]]]
                  set p_05    [rc_Domain::vectormath::rotateLine $p_03 [expr 0.5 * $segLength] [expr 180 + $dirAngle]]
                  set p_06    $orient_03
                  set p_15    [rc_Domain::vectormath::addVector $p_04  [list 0         [expr 1.0 * $bendRadius]]]
              ...
              set tubeProfile [rc_Domain::lib_tube::init_tubeProfile $profileDef]              
          ...
          straight {
              ...
              set dirAngle     [expr (180/$rc_Domain::vectormath::CONST_PI) * ($_dAngle - $_pAngle)]
              ...
              set p_02    [rc_Domain::vectormath::rotateLine $p_01 $dropOutOffset  [expr 180 + $dirAngle]]
              set p_03    [rc_Domain::vectormath::rotateLine $p_02 $endLength      [expr 180 + $dirAngle]]
              set p_04    [rc_Domain::vectormath::rotateLine $p_03 [expr 1.00 * $segLength]  [expr 180 + $dirAngle]]
              set p_05    [rc_Domain::vectormath::rotateLine $p_04 [expr 1.00 * $segLength]  [expr 180 + $dirAngle]]
              set p_06    [list 0 0] 
              set p_15    [rc_Domain::vectormath::rotateLine $p_03 100  [expr 170 + $dirAngle]]
          ...
          max {
              ...
              set a_gamma   [expr $rc_Domain::vectormath::CONST_PI-($bendAngle+$a_bend_DO)]
              ...
              set a_alpha     [expr $rc_Domain::vectormath::CONST_PI - $a_beta - $a_gamma]
                # puts "   -> \$a_beta   $a_beta"               
              ...
              set dirAngle    [expr $a_offset + $a_beta - $a_bend_DO]
                # puts "\n"
                # puts "   -> \$dirAngle  $dirAngle"     
              set dirAngle    [rc_Domain::vectormath::grad $dirAngle]
                # puts "   -> \$dirAngle  $dirAngle"     
                # puts "\n"
              # puts "   -> \$max_Offset $max_Offset"  
              ...
              set p_01    [rc_Domain::vectormath::rotateLine $p_00 $dropOutPerp    [expr 270 + $dirAngle]]
              set p_02    [rc_Domain::vectormath::rotateLine $p_01 $dropOutOffset  [expr 180 + $dirAngle]]
              set p_03    [rc_Domain::vectormath::rotateLine $p_02 [expr $max_endLength - 30]     [expr 180 + $dirAngle]]
              set p_04    [rc_Domain::vectormath::rotateLine $p_02 $max_endLength  [expr 180 + $dirAngle]]
              set p_05    [rc_Domain::vectormath::rotateLine $p_04 30 [expr 180 + $dirAngle  - $bendAngle*(180/$rc_Domain::vectormath::CONST_PI)]]
              set p_06    [list 0 0] 
              set p_15    [rc_Domain::vectormath::addVector $p_04  [list 0         [expr 1.0 * $max_bendRadius]]]

              set angleRotation [expr 180 + $dirAngle]  
                # puts "   -> \$angleRotation $angleRotation\n"

              set S01_length  [rc_Domain::vectormath::length $p_02 $p_04]
              set S02_length  [expr [rc_Domain::vectormath::length $p_04 $p_06] - 20] ;#[expr $length_bladeDO - $S01_length - 20]
              set S03_length  10                
              set S04_length  10                                          
              set S01_angle   [expr -1.0 * $bendAngle * (180/$rc_Domain::vectormath::CONST_PI)]
              set S02_angle   0                       
              set S03_angle   0                       
        ...
        foreach _p {p_00 p_01 p_02 p_03 p_04 p_05 p_06 p_15} {
          eval set xy \$$_p
            # puts "   $_p $xy"
          set xy [rc_Domain::vectormath::addVector $xy [list $crownOffset $crownPerp]]
          set $_p ${xy}
        }
        ...
        set retValues [rc_Domain::lib_tube::init_centerLine $centerLineDef] 
        set centerLine  [lindex $retValues 0]
        set ctrLines    [lindex $retValues 1]
        
            # -- draw shape of tube
        set outLineLeft   [rc_Domain::lib_tube::get_tubeShape    $centerLine $tubeProfile left  ]
        set outLineRight  [rc_Domain::lib_tube::get_tubeShape    $centerLine $tubeProfile right ]
        ...
        # set addVector [rc_Domain::vectormath::addVector $dropOutPos [list $dropOutOffset $dropOutPerp]]
        #puts "  ->    \$dropOutPos $dropOutPos"     
        #puts "     ->    $dropOutOffset $dropOutPerp"     
        #puts "     ->    $addVector $addVector" 
    
            # -- get oriented tube
        set outLine [rc_Domain::vectormath::addVectorPointList         $addVector $outLine]
        set outLine [rc_Domain::vectormath::rotatePointList {0 0}      $outLine $angleRotation]
        set outLine [rc_Domain::vectormath::addVectorPointList         $dropOutPos $outLine]
        
            # -- get oriented centerLine
        set centerLine [rc_Domain::vectormath::addVectorPointList      $addVector [appUtil::flatten_nestedList $centerLine]]
        set centerLine [rc_Domain::vectormath::rotatePointList {0 0}   $centerLine $angleRotation]
        set centerLine [rc_Domain::vectormath::addVectorPointList      $dropOutPos $centerLine]
        
            # -- get oriented brakeDefLine
        set brakeDefLine [rc_Domain::vectormath::addVectorPointList    $addVector [appUtil::flatten_nestedList $brakeDefLine]]
        set brakeDefLine [rc_Domain::vectormath::rotatePointList {0 0} $brakeDefLine $angleRotation]
        set brakeDefLine [rc_Domain::vectormath::addVectorPointList    $dropOutPos $brakeDefLine]
    ...
    proc get_tubeShape {centerLine tubeProfile side} {
        ...
        foreach p $centerLine {
          ...
          set angle       [rc_Domain::vectormath::dirAngle $p_SegStart $p_SegEnd]
          set l_segment   [rc_Domain::vectormath::length   $p_SegStart $p_SegEnd]
              #puts "\n-----------"
          ...
          while {$i < $nrSegments} {
            ...
            set lineOffset    [get_tubeProfileOffset $tubeProfile $linePosition]
            set p_End         [rc_Domain::vectormath::rotateLine $p_Start $l_segment   $angle]
            set p_Offset      [rc_Domain::vectormath::rotateLine $p_End   $lineOffset  $offsetAngle]
              # -- add to bentProfile
    ...
    proc get_shapeInterSection {shape length} {
        ...
        while {$shapeIndex < $shape_llength} {
          ...
          set xAbs  [expr abs($x)]
          set yAbs  [expr abs($y)]
          set lpIdx    [rc_Domain::vectormath::length {0 0} $pIdx]
          ...
          set pNow  $pLast
          set dir   [rc_Domain::vectormath::dirAngle $pLast $pIdx] 
          set lEnd  [rc_Domain::vectormath::length {0 0} $pIdx]
          
          if {$lpIdx > $length} {
              set lNow [rc_Domain::vectormath::length {0 0} $pLast]
              while {$lNow < $length} {
                set pNow [rc_Domain::vectormath::rotateLine $pNow $precission $dir]
                set lNow [rc_Domain::vectormath::length {0 0} $pNow]
              }
              return $pNow
          }
        }
        ...
        set lNow  [rc_Domain::vectormath::length {0 0} $pNow]
        set dir   [rc_Domain::vectormath::dirAngle $pLast $pNow]
