 ...
 #
    ...
    proc rattleCAD::cv_custom::createDimension {cv_Name BB_Position type {active {on}}} {
            ...
            switch $type {
                ...
                point_frame_dimension { createDimension_CLineFrame      $cv_Name $BB_Position $type;            return }
                cline_frame         { createDimension_PointCenter       $cv_Name $BB_Position $type;            return }
    ...
    proc rattleCAD::cv_custom::createDimension_PointFrameDimension  {cv_Name BB_Position type} {
