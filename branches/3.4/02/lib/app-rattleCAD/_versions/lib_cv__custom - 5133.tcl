 ...
 namespace eval rattleCAD::cv_custom {
    ...
    proc update_cv_Parameter {cv_Name BB_Position} {
            ...
            set DownTube(OffsetBB)          [ rattleCAD::model::get_Scalar      DownTube        OffsetBB ]
                ...
                # set RearDrop(OffsetSSPerp)      $bikeGeometry::RearDropout(OffsetSSPerp)
                # set RearDrop(OffsetCSPerp)      $bikeGeometry::RearDropout(OffsetCSPerp)
            ...
            set Steerer(Diameter)       30.0
				...
				set   dir_01                [ split [rattleCAD::model::getValue  Result/Tubes/Steerer/Direction/polar ] ,]
    ...
    proc get_BottomBracket_Position {cv_Name bottomCanvasBorder {updatePosition {recenter}} {option {bicycle}} {stageScale {}}} {
	    ...
	    if {$option == {bicycle}} {
            ...
            set BtmBracket_y        [ expr $cvBorder + $BottomBracketHeight ]
                # puts "\n -> get_BottomBracket_Position:  $cvBorder + $RearWheel(Radius) - [rattleCAD::model::getValue Custom/BottomBracket/Depth] "
