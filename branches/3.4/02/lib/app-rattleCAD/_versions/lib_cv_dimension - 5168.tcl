 ...
 #
    ...
    proc rattleCAD::cv_custom::createDimension {cv_Name BB_Position type {active {on}}} {
            ...
            switch $type {
                ...
                geometry_bg {
                    ...
                    # -----------------------
                geometry_fg {
                            createDimension_Geometry_FG $cv_Name $BB_Position $type $active
                            return
                    ...
                    # -----------------------
                frameTubing_bg {
                            createDimension_FrameTubing_BG  $cv_Name $BB_Position $type
                            return
                    ...
                    # -----------------------
                summary_bg {
                            createDimension_Summary_BG  $cv_Name $BB_Position $type
                            return
                    ...
                    # -----------------------
                summary_fg {
                            createDimension_Summary_FG  $cv_Name $BB_Position $type $active
                            return
                    ...
                    # -----------------------
                frameDrafting_bg {
                            createDimension_FrameDrafting_BG $cv_Name $BB_Position $type
                            return
                    ...
                    # -----------------------
                reference_bg {
                            createDimension_Reference_BG $cv_Name $BB_Position $type
                            return
                    ...
                    # -----------------------
                reference_fg {  
                            createDimension_Reference_FG  $cv_Name $BB_Position $type
                            return
    ...
    proc rattleCAD::cv_custom::createDimension_Any {cv_Name BB_Position type {active {on}}} {
