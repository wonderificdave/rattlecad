    proc rattleCAD::view::edit::editView {x y cv_Name} { 
            # title {BottleCage DownTube Offset} #
    ...
    proc rattleCAD::view::edit::editView {x y cv_Name} { 
            # title {BottleCage DownTube Lower Offset} #
            rattleCAD::view::createEdit  $x $y $cv_Name \ 
    ...
    proc rattleCAD::view::edit::editView {x y cv_Name} { 
            # title {BottleCage SeatTube Offset} #
            rattleCAD::view::createEdit  $x $y $cv_Name \ 
    ...
    proc rattleCAD::view::edit::editView {x y cv_Name} { 
            # title {Steerer/Fork:  Settings} #
            rattleCAD::view::createEdit  $x $y $cv_Name \ 
                    Component(Stem/Angle) \ 
                    Component(Stem/Length) \ 
                    Component(Fork/Height) \ 
                    Component(Fork/Rake) \ 
                    {Steerer/Fork:  Settings}
    }
    proc rattleCAD::view::edit::editView {x y cv_Name} { 
            # title {} #
            rattleCAD::view::createEdit  $x $y $cv_Name \ 
    ...
    proc rattleCAD::view::edit::editView {x y cv_Name} { 
            # title { BottomBracket:  Settings} #
            rattleCAD::view::createEdit  $x $y $cv_Name \ 
                    Custom(BottomBracket/Depth) \ 
                    Result(Length/BottomBracket/Height) \ 
                    { BottomBracket:  Settings}
    }
        
    proc rattleCAD::view::edit::editView {x y cv_Name} { 
            # title {DownTube Offset BottomBracket} #
            rattleCAD::view::createEdit  $x $y $cv_Name \ 
    ...
    proc rattleCAD::view::edit::editView {x y cv_Name} { 
            # title {HeadTube DownTube Offset} #
            rattleCAD::view::createEdit  $x $y $cv_Name \ 
    ...
    proc rattleCAD::view::edit::editView {x y cv_Name} { 
            # title {SeatTube Offset BottomBracket} #
            rattleCAD::view::createEdit  $x $y $cv_Name \ 
                    Custom(SeatTube/OffsetBB) \ 
    ...
    proc rattleCAD::view::edit::editView {x y cv_Name} { 
            # title {} #
            rattleCAD::view::createEdit  $x $y $cv_Name \ 
                    FrameTubes(ChainStay/Profile/cuttingRight) \ 
                    {}
    }
    ...
    proc rattleCAD::view::edit::editView_Check {x y cv_Name} {
    ...
    proc rattleCAD::view::edit::editView {x y cv_Name} { 
            # title { DerailleurFront Parameter } #
            rattleCAD::view::createEdit  $x $y $cv_Name \ 
    ...
    proc rattleCAD::view::edit::editView {x y cv_Name} { 
            # title { DerailleurRear Parameter } #
            rattleCAD::view::createEdit  $x $y $cv_Name \ 
    ...
    proc rattleCAD::view::edit::editView {x y cv_Name} { 
            # title {RearHub: first Sprocket  } #
            rattleCAD::view::createEdit  $x $y $cv_Name \ 
                    text://Component(Wheel/Rear/FirstSprocket) \ 
                    {RearHub: first Sprocket  }
    }
        
        

    proc rattleCAD::view::edit::__DONE__editView {x y cv_Name} { 
            # title { DiscBrake Details} #
            rattleCAD::view::createEdit  $x $y $cv_Name \ 
    ...
    proc rattleCAD::view::edit::__DONE__editView {x y cv_Name} { 
            # title { ChainStay:  CenterLine  } #
            rattleCAD::view::createEdit  $x $y $cv_Name \ 
                    list://Rendering(ChainStay@SELECT_ChainStay) \ 
                    { ChainStay:  CenterLine  }
    } 
    proc rattleCAD::view::edit::__DONE__editView {x y cv_Name} {
            # title{ ChainStay:  Type} #
            rattleCAD::view::createEdit  $x $y $cv_Name \ 
                    list://Rendering(ChainStay@SELECT_ChainStay) \ 
                    { ChainStay:  Type}
    }        
