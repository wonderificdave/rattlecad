 ...
 namespace eval rattleCAD::rendering {
    ...
    proc rattleCAD::rendering::createDecoration {cv_Name BB_Position type {updateCommand {}}} {
            ...
            switch $type {
                    ...
                    RearWheel {     # --- create RearWheel -----------------
                                ...
                                if {$updateCommand != {}}   { 
                                        rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $my_Rim     single_RearWheelRimHeight
                    ...
                    FrontWheel {    # --- create FrontWheel ----------------
                                ...
                                if {$updateCommand != {}}   { 
                                        rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $my_Rim     single_FrontWheelRimHeight    
    ...
    proc rattleCAD::rendering::createFrame_Tubes {cv_Name BB_Position {updateCommand {}}} {
        ...
        if {$updateCommand != {}}   { 
                $cv_Name bind    $DownTube(object)    <Double-ButtonPress-1> \
        ...
        if {$updateCommand != {}}   { 
                $cv_Name bind    $SeatTube(object)   <Double-ButtonPress-1> \
        ...
        if {$updateCommand != {}}   { 
                $cv_Name bind    $TopTube(object)    <Double-ButtonPress-1> \
        ...
        if {$updateCommand != {}}   { 
                $cv_Name bind    $ChainStay(object)    <Double-ButtonPress-1> \
        ...
        if {$updateCommand != {}}   { 
                $cv_Name bind    $SeatStay(object)    <Double-ButtonPress-1> \
        ...
        if {$updateCommand != {}}   { 
                $cv_Name bind     $RearDropout(object)    <Double-ButtonPress-1> \
        ...
        if {$updateCommand != {}}   { 
                $cv_Name bind    __BottomBracket__    <Double-ButtonPress-1> \
