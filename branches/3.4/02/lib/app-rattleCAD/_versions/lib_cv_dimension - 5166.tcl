 ...
 #
            ...
            switch $type {
                ...
                geometry_fg {
                            ...
                            if {$active == {on}} {
                                    ...
                                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_BB_Height   single_BottomBracketHeight
                                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $_dim_RW_Radius   group_RearWheelParameter
                                    ...
                                    $cv_Name bind $_dim_Fork_Height     <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  Component(Fork/Height) ]
                                        #$cv_Name bind $_dim_RW_Radius  <Double-ButtonPress-1>  [list rattleCAD::view::edit::rearWheelParameter        %x %y  $cv_Name]
                                    ...
                                    # $cv_Name bind $_dim_BB_Height       <Double-ButtonPress-1>  [list rattleCAD::view::edit::bottomBracketHeight    %x %y  $cv_Name]
                ...
                frameDrafting_bg {
                            ...
                            set _dim_Fork_Height        [ $cv_Name dimension  length            [ appUtil::flatten_nestedList            $Steerer(vct_Bottom) $FrontWheel(Position)  ] \
                                ...
                                # -- Steerer Details ----------------------
                                set pt_01                    [ rattleCAD::model::get_Position   Steerer/Start   $BB_Position  ]
                                set pt_02                    [ rattleCAD::model::get_Position   Steerer/End     $BB_Position  ]
                           ...
                           set _dim_HeadTube_Angle      [ $cv_Name dimension  angle            [ appUtil::flatten_nestedList [list $pt_01 $Steerer(Stem) $pt_02] ] \
                            ...
                            if {$Rendering(BrakeRear) != {off}} {
                                switch $Rendering(BrakeRear) {
                                    Rim {
                                                ...
                                                set pt_03                   [ rattleCAD::model::get_Position    RearBrakeShoe   $BB_Position  ]
                                                set pt_04                   [ rattleCAD::model::get_Position    RearBrakeHelp   $BB_Position  ]
                            ...
                            if {$Rendering(BottleCage_ST) != {off}} {
                                            ...
                                            set pt_01                   [ rattleCAD::model::get_Position    SeatTube/BottleCage/Offset  $BB_Position]
                                            set pt_02                   [ rattleCAD::model::get_Position    SeatTube/BottleCage/Base    $BB_Position]
                            ...
                            if {$Rendering(BottleCage_DT) != {off}} {
                                            ...
                                            set pt_01                   [ rattleCAD::model::get_Position     DownTube/BottleCage/Offset $BB_Position ]
                                            set pt_02                   [ rattleCAD::model::get_Position     DownTube/BottleCage/Base   $BB_Position ]
                            ...
                            if {$Rendering(BottleCage_DT_L) != {off}} {
                                            set dt_direction            [ rattleCAD::model::get_Direction   DownTube ]
                                            set pt_01                   [ rattleCAD::model::get_Position    DownTube/BottleCage_Lower/Offset    $BB_Position ]
                                            set pt_02                   [ rattleCAD::model::get_Position    DownTube/BottleCage_Lower/Base      $BB_Position ]
                           ...
                           #rattleCAD::view::gui::cv_Custom40 setPrecision 2
                            ...
                            set _dim_SeatTube_Extension [ $cv_Name dimension  length            [ appUtil::flatten_nestedList [list $pt_01 $pt_02] ] \
                                ...
                                set pt_01               [ rattleCAD::model::get_Position TopTube/Start  $BB_Position  ]
                                set pt_02               [ rattleCAD::model::get_Position SeatStay/End   $BB_Position  ]
                            ...
                            if { $DownTube(OffsetBB) != 0 } {
                                    set pt_01           [ rattleCAD::model::get_Position    DownTube/End    $BB_Position  ]
                                    set pt_02           [ rattleCAD::model::get_Position    DownTube/Start  $BB_Position  ]
                            ...
                            if { $SeatTube(OffsetBB) != 0 } {
                                    set pt_01                [ rattleCAD::model::get_Position    SeatTube/End   $BB_Position  ]
                                    set pt_02                [ rattleCAD::model::get_Position    SeatTube/Start $BB_Position  ]
                                    set pt_03               $BB_Position
                                    if { [lindex $pt_02 1] >= [lindex $pt_03 1] } {
                                            set dim_distance    [expr -70 * $stageScale]
                                            set dim_offset      [expr -50 * $stageScale]
                                ...
                                set pt_01               [ rattleCAD::model::get_Position    TopTube/End     $BB_Position  ]
                                set pt_hlp              [ rattleCAD::model::get_Position    TopTube/Start   $BB_Position  ]
                            ...
                            set _dim_TopTube_Angle      [ $cv_Name dimension  angle            [ appUtil::flatten_nestedList [list $pt_cnt $pt_02 $pt_01] ] \
                                ...
                                set pt_01               [ rattleCAD::model::get_Position    HeadTube/Start  $BB_Position  ]
                                set pt_02               [ rattleCAD::model::get_Position    Steerer/Start   $BB_Position  ]
    ...
    proc rattleCAD::cv_custom::createDimensionType {cv_Name BB_Position type {updateCommand {}}} {
            ...
            switch $type {
                HeadTube_Length {
                            createDimension_HeadTubeLength      $cv_Name $BB_Position $type $updateCommand
                            return
                ...
                HeadTube_OffsetTT {
                            createDimension_HeadTubeOffsetTT    $cv_Name $BB_Position $type $updateCommand
                            return
                            set pt_01           [ rattleCAD::model::coords_get_xy $HeadTube(polygon) 2 ]
                            set pt_02           [ rattleCAD::model::coords_get_xy $TopTube(polygon) 8 ]
                ...
                HeadTube_OffsetDT {
                            createDimension_HeadTubeOffsetDT    $cv_Name $BB_Position $type $updateCommand
                            return
                            set pt_01           [ rattleCAD::model::coords_get_xy $HeadTube(polygon) 3 ]
                            set pt_02           [ rattleCAD::model::coords_get_xy $DownTube(polygon) 2 ]
                            set dimension       [ $cv_Name dimension  length            [ appUtil::flatten_nestedList [list $pt_01 $pt_02] ] \
                ...
                SeatTube_Extension {
                            createDimension_SeatTubeExtension   $cv_Name $BB_Position $type $updateCommand
                            return
                            set pt_01           [ rattleCAD::model::coords_get_xy $TopTube(polygon) 11 ]
                            set pt_02           [ rattleCAD::model::coords_get_xy $SeatTube(polygon) 2 ]
                            set dimension       [ $cv_Name dimension  length            [ appUtil::flatten_nestedList [list $pt_01 $pt_02] ] \
                ...
                SeatStay_Offset {
                            createDimension_SeatStayOffset      $cv_Name $BB_Position $type $updateCommand
                            return
                            ...
                            set dimension       [ $cv_Name dimension  length            $dim_coords  \
                                                                                    ...
                                                                                    darkred ]
                            if {$updateCommand != {}} { 
                                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $dimension      single_SeatStayOffsetTT
                                    # $cv_Name    bind    $dimension    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name      { Custom(SeatStay/OffsetTT) }   {SeatStay Offset TopTube}]
                                    # rattleCAD::view::gui::object_CursorBinding        $cv_Name    $dimension
                                }
                            }
                DownTube_Offset {
                            createDimension_DownTubeOffset      $cv_Name $BB_Position $type $updateCommand
                            return
                            ...
                            if {$updateCommand != {}} { 
                                    ...
                                    # $cv_Name    bind    $dimension    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Custom(DownTube/OffsetBB) }    {DownTube Offset BottomBracket}]
                                    # rattleCAD::view::gui::object_CursorBinding        $cv_Name    $dimension
                            }
                        }
                SeatTube_Offset {
                            createDimension_SeatTubeOffset      $cv_Name $BB_Position $type $updateCommand
                            return
                            ...
                            if {$updateCommand != {}} { 
                                    ...
                                    # $cv_Name    bind    $dimension    <Double-ButtonPress-1>    [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Custom(SeatTube/OffsetBB) }    {SeatTube Offset BottomBracket}]
                                    # rattleCAD::view::gui::object_CursorBinding        $cv_Name    $dimension
                            }
                        }
                TopTube_Angle {
                            createDimension_TopTubeAngle        $cv_Name $BB_Position $type $updateCommand
                            return
                            ...
                            if {$updateCommand != {}} {
                                    ...
                                    # $cv_Name    bind    $dimension    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Custom(TopTube/Angle) }    {TopTube Angle}]
                                    # rattleCAD::view::gui::object_CursorBinding        $cv_Name    $dimension
                            }
                        }
                TopHeadTube_Angle {
                            createDimension_TopHeadTubeAngle    $cv_Name $BB_Position $type $updateCommand
                            return
                            set dimension       [ $cv_Name dimension  angle     [ appUtil::flatten_nestedList [list $TopTube(Steerer) $Steerer(Stem) $TopTube(SeatTube)] ] \
                                                                                    150   0 \
                                                                                    darkblue ]
                            if {$updateCommand != {}} { 
                                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $dimension      single_HeadTubeTopTubeAngle
                                    # $cv_Name    bind    $dimension    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Result(Angle/HeadTube/TopTube) }    {HeadTube TopTube Angle}]
                                    # rattleCAD::view::gui::object_CursorBinding        $cv_Name    $dimension
                            }
                        }
                ForkHeight {
                            createDimension_ForkHeight          $cv_Name $BB_Position $type $updateCommand
                            return
                            set dimension       [ $cv_Name dimension  length    [ appUtil::flatten_nestedList            $Steerer(vct_Bottom) $FrontWheel(Position) ] \
                                                                                    ...
                                                                                    darkred ]
                            if {$updateCommand != {}} { 
                                    rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $dimension      single_ForkHeight
                                    # $cv_Name    bind    $dimension    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Component(Fork/Height) }    {Fork Height}]
                                    # rattleCAD::view::gui::object_CursorBinding        $cv_Name    $dimension
                            }
                        }
                HeadSet_Top {
                            createDimension_HeadSetTop      $cv_Name $BB_Position $type $updateCommand
                            return
                                set dimension       [ $cv_Name dimension  length    [ appUtil::flatten_nestedList $HeadSet(vct_Top)  [lindex $HeadTube(vct_Top) 1]] \
                                                                                        ...
                                                                                        darkred ]
                                if {$updateCommand != {}} { 
                                        rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $dimension      single_HeadSetTopHeight
                                        # $cv_Name    bind    $dimension    <Double-ButtonPress-1>    [list rattleCAD::view::createEdit  %x %y  $cv_Name      { Component(HeadSet/Height/Top) }    {HeadSet Top Height}]
                                        # rattleCAD::view::gui::object_CursorBinding        $cv_Name    $dimension
                                }
                        }
                HeadSet_Bottom {
                            createDimension_HeadSetBottom   $cv_Name $BB_Position $type $updateCommand
                            return
                                set dimension       [ $cv_Name dimension  length    [ appUtil::flatten_nestedList $HeadSet(vct_Bottom)  [lindex $HeadTube(vct_Bottom) 1]] \
                                                                                        ...
                                                                                        darkred ]
                                if {$updateCommand != {}} { 
                                        rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $dimension      single_HeadSetBottomHeight
                                        # $cv_Name    bind    $dimension    <Double-ButtonPress-1>    [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Component(HeadSet/Height/Bottom) }    {HeadSet Bottom Height}]
                                        # rattleCAD::view::gui::object_CursorBinding        $cv_Name    $dimension
                                }
                        }
                Brake_Rear {
                            createDimension_BrakeRear   $cv_Name $BB_Position $type $updateCommand
                            return
                            if {$Rendering(BrakeRear) != {off}} {
                                switch $Rendering(BrakeRear) {
                                    Rim {
                                                set pt_03       [ rattleCAD::model::get_Position    RearBrakeShoe        $BB_Position ]
                                                set pt_04       [ rattleCAD::model::get_Position    RearBrakeHelp        $BB_Position ]
                                                set pt_05       [ rattleCAD::model::get_Position    RearBrakeDefinition  $BB_Position ]
                                                set pt_06       [ rattleCAD::model::get_Position    RearBrakeMount       $BB_Position ]
                                            ...
                                            if {$updateCommand != {}} { 
                                                    ...
                                                    # $cv_Name    bind    $dimension_01    <Double-ButtonPress-1>     [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Component(Brake/Rear/Offset) }    {Rear Brake Offset}]
                                                    # $cv_Name    bind    $dimension_02    <Double-ButtonPress-1>     [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Component(Brake/Rear/LeverLength) }   {Rear Brake LeverLength}]
                ...
                Brake_Front {
                            createDimension_BrakeFront  $cv_Name $BB_Position $type $updateCommand
                            return
                            
                            if {$Rendering(BrakeFront) != {off}} {
                                switch $Rendering(BrakeFront) {
                                    Rim {
                                                set pt_03       [ rattleCAD::model::get_Position    FrontBrakeShoe          $BB_Position ]
                                                set pt_04       [ rattleCAD::model::get_Position    FrontBrakeHelp          $BB_Position ]
                                                set pt_05       [ rattleCAD::model::get_Position    FrontBrakeDefinition    $BB_Position ]
                                                set pt_06       [ rattleCAD::model::get_Position    FrontBrake              $BB_Position ]
                                            ...
                                            if {$updateCommand != {}} { 
                                                    ...
                                                    # $cv_Name    bind    $dimension_01    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Component(Brake/Front/Offset) }    {Front Brake Offset}]
                                                    # $cv_Name    bind    $dimension_02    <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Component(Brake/Front/LeverLength) }    {Front Brake LeverLength}]
                                                    # rattleCAD::view::gui::object_CursorBinding        $cv_Name    $dimension_01
                                                    # rattleCAD::view::gui::object_CursorBinding        $cv_Name    $dimension_02
                                            }
                                        }
                ...
                BottleCage {
                            createDimension_BottleCage  $cv_Name $BB_Position $type $updateCommand
                            return
                ...
                DerailleurMount {
                            createDimension_DerailleurMount  $cv_Name $BB_Position $type $updateCommand
                            return
                            
                                set pt_01     [ rattleCAD::model::get_Position      RearWheel                       $BB_Position ]
                                set pt_02     [ rattleCAD::model::get_Position      Lugs/Dropout/Rear/Derailleur    $BB_Position ]
                                ...
                                set chainStayAngle [ vectormath::dirAngle   $pt_01  $BB_Position]
                                    #
                                set direction   [ rattleCAD::model::get_Option RearDropoutOrient]
                                ...
                                set dimension_04    [ $cv_Name dimension  length    [ appUtil::flatten_nestedList   $pt_03 $pt_01 $pt_02 ] \
                                    ...
                                    #																								
                                if {$updateCommand != {}} { 
                                            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $dimension_01   group_RearDerailleurMount
                                            rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $dimension_02   group_RearDerailleurMount
                                            
                                            #rattleCAD::view::gui::object_CursorBinding        $cv_Name    $dimension_01
                                            #rattleCAD::view::gui::object_CursorBinding        $cv_Name    $dimension_02
                                            #$cv_Name bind   $dimension_01   <Double-ButtonPress-1>  [list rattleCAD::view::edit::rearDerailleurMount %x %y  $cv_Name ]
                                            # $cv_Name bind   $dimension_01   <Double-ButtonPress-1>  \
                                            #        [list rattleCAD::view::createEdit  %x %y  $cv_Name  { file://Lugs(RearDropOut/File)  \
                                            ...
                                            #$cv_Name bind   $dimension_02   <Double-ButtonPress-1>  [list rattleCAD::view::edit::rearDerailleurMount %x %y  $cv_Name ]
                ...
                RearWheel_Clearance {
                            createDimension_RearWheelClearance  $cv_Name $BB_Position $type
                            return
                                set RimDiameter         [rattleCAD::model::get_Scalar       RearWheel RimDiameter]
                                set TyreHeight          [rattleCAD::model::get_Scalar       RearWheel TyreHeight]
                                set WheelRadius         [ expr 0.5 * $RimDiameter + $TyreHeight ]
                ...
                LegClearance {
                            createDimension_LegClearance        $cv_Name $BB_Position $type
                            return
                ...
                check_this {
                            ...
                            if {$updateCommand != {}} {
                                        rattleCAD::view::gui::dimension_CursorBinding   $cv_Name    $dimension      single_SeatStayOffsetTT
                                        # rattleCAD::view::gui::object_CursorBinding        $cv_Name    $dimension
                                        # $cv_Name bind   $dimension      <Double-ButtonPress-1>  [list rattleCAD::view::createEdit  %x %y  $cv_Name  { Custom(SeatStay/OffsetTT) }   {SeatStay OffsetTopTube}]  
                                    }
                        }
                default {}
            }
