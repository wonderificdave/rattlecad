...
3.4.02.68  - 2015.09.16
-------------------------------------------------------------------------------
    debug:
        ... bikeGeometry 1.61


3.4.02.67  - 2015.09.15
-------------------------------------------------------------------------------
    debug:
        ... bikeGeometry 1.60
...
-------------------------------------------------------------------------------
    refactor:
        ... frameTubeColour ... rattleCAD::cv_custom::frameTubeColour 
            ... from wheat -> #edc778
...
3.4.02.55  - 2015.05.11
-------------------------------------------------------------------------------
    debug:
        ... rattleCAD::view::cboxWidth      15
        ... rattleCAD::view::svgEdit::create_svgEdit            
            ... take extra space for $compList


3.4.02.54  - 2015.05.10
-------------------------------------------------------------------------------
    debug:
        ... init variable exec_GhostScript to {}


3.4.02.53  - 2015.05.09
-------------------------------------------------------------------------------
    debug:
